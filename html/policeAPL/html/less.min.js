    ...
    return (function a(b, c, d) {
            ...
            function(a, b, c) {
                ...
                b.exports = {
                    createCSS: function(a, b, c) {
                        var e = c.href || '', f = 'less:' + (c.title || d.extractId(e)), g = a.getElementById(f), h = !1, i = a.createElement('style');
                ...
                b.exports = function(a, b, c) {
                    ...
                    return {
                        ...
                        getCSS: function(a, b, c) {
                            var e = d && d.getItem(a), f = d && d.getItem(a + ':timestamp'), g = d && d.getItem(a + ':vars');
        ...
        5: [
            function(a, b, c) {
                ...
                b.exports = function(a, b, c) {
                    function f(b, f) {
                        var g, h, i = 'less-error-message:' + d.extractId(f || ''), j = '<li><label>{line}</label><pre class="{class}">{content}</pre></li>', k = a.document.createElement('div'), l = [], m = b.filename || f, n = m.match(/([^\/]+(\?.*)?)$/)[1];
                        ...
                        b.line && (o(b, 0, ''), o(b, 1, 'line'), o(b, 2, ''), h += 'on line ' + b.line + ', column ' + (b.column + 1) + ':</p><ul>' + l.join('') + '</ul>'), b.stack && (b.extract || c.logLevel >= 4) && (h += '<br/>Stack Trace</br />' + b.stack.split('\n').slice(1).join('<br/>')), k.innerHTML = h, e.createCSS(a.document, [
                            ...
                            'padding: 15px',
                            'margin-bottom: 15px'
                        ].join(';'), 'development' === c.env && (g = setInterval(function() {
                    ...
                    function j(a, d) {
                        var e = '{line} {content}', f = a.filename || d, g = [], h = (a.type || 'Syntax') + 'Error: ' + (a.message || 'There is an error in your .less file') + ' in ' + f, i = function(a, b, c) {
        ...
        10: [
            function(a, b, c) {
                var d = a('../less/environment/abstract-plugin-loader.js'), e = function(a) {
                    this.less = a;
                };
            ...
            function(a, b, c) {
                b.exports = {
                    ...
                    addDataAttr: function(a, b) {
                        for(var c in b.dataset)if (b.dataset.hasOwnProperty(c)) if ('env' === c || 'dumpLineNumbers' === c || 'rootpath' === c || 'errorReporting' === c) a[c] = b.dataset[c];
                        else try {
        ...
        13: [
            function(a, b, c) {
                ...
                var f = {};
                b.exports = f;
                var g = a('./constants'), h = function(a, b, c) {
                ...
                f.Parse = function(a) {
                    h(a, this, i), 'string' == typeof this.paths && (this.paths = [
                        this.paths
                    ]);
                };
                var j = [
                ...
                f.Eval = function(a, b) {
                    h(a, this, j), 'string' == typeof this.paths && (this.paths = [
                        this.paths
                    ]), this.frames = b || [], this.importantScope = this.importantScope || [];
                ...
                }, f.Eval.prototype.inCalc = !1, f.Eval.prototype.mathOn = !0, f.Eval.prototype.isMathOn = function(a) {
                    return !!this.mathOn && !!('/' !== a || this.math === g.Math.ALWAYS || this.parensStack && this.parensStack.length) && (!(this.math > g.Math.PARENS_DIVISION) || this.parensStack && this.parensStack.length);
        ...
        18: [
            function(a, b, c) {
                ...
                d.prototype.getPath = function(a) {
                    ...
                    var c, d, e = /^((?:[a-z-]+:)?\/{2}(?:[^\/\?#]*\/)|([\/\\]))?((?:[^\/\\\?#]*[\/\\])*)([^\/\\\?#]*)([#\?].*)?$/i, f = a.match(e), g = {}, h = [], i = [];
        ...
        19: [
            function(a, b, c) {
                var d = a('../functions/function-registry'), e = a('../less-error'), f = function() {
                ...
                f.prototype.evalPlugin = function(a, b, c, f, g) {
                    ...
                    try {
                        ...
                        return p2.message = p2.message || 'Error during @plugin call', new e(p2, c, m);
                    }
                    return j;
        ...
        20: [
            function(a, b, c) {
                var d = a('../logger'), e = function(a, b) {
                    ...
                    ], d = [], e = d.concat(c), f = 0; f < e.length; f++){
                        var g = e[f], h = a[g];
            ...
            function(a, b, c) {
                ...
                var e = a('../tree/color'), f = a('./function-registry'), g = {
                    ...
                    softlight: function(a, b) {
                        var c = 1, d = a;
                        return b > 0.5 && (d = 1, c = a > 0.25 ? Math.sqrt(a) : ((16 * a - 12) * a + 4) * a), a - (1 - 2 * b) * d * (c - a);
                    },
        ...
        23: [
            function(a, b, c) {
                ...
                var h, i = a('../tree/dimension'), j = a('../tree/color'), k = a('../tree/quoted'), l = a('../tree/anonymous'), m = a('./function-registry');
                h = {
                    rgb: function(a, b, c) {
                    ...
                    hsla: function(a, b, c, e) {
                        function g(a) {
                            return a = a < 0 ? a + 1 : a > 1 ? a - 1 : a, 6 * a < 1 ? h + (i - h) * a * 6 : 2 * a < 1 ? i : 3 * a < 2 ? h + (i - h) * (2 / 3 - a) * 6 : h;
                        }
                        try {
                            if (a instanceof j) return e = b ? f(b) : a.alpha, new j(a.rgb, e, 'hsla');
                            var h, i;
                            a = f(a) % 360 / 360, b = d(f(b)), c = d(f(c)), e = d(f(e)), i = c <= 0.5 ? c * (b + 1) : c + b - c * b, h = 2 * c - i;
                            var k = [
                                255 * g(a + 1 / 3),
                                255 * g(a),
                                255 * g(a - 1 / 3)
                    ...
                    saturate: function(a, b, c) {
                        ...
                        var f = a.toHSL();
                        return f.s += 'undefined' != typeof c && 'relative' === c.value ? f.s * b.value / 100 : b.value / 100, f.s = d(f.s), e(a, f);
                    },
                    ...
                    lighten: function(a, b, c) {
                        var f = a.toHSL();
                        return f.l += 'undefined' != typeof c && 'relative' === c.value ? f.l * b.value / 100 : b.value / 100, f.l = d(f.l), e(a, f);
                    },
                    ...
                    fadein: function(a, b, c) {
                        var f = a.toHSL();
                        return f.a += 'undefined' != typeof c && 'relative' === c.value ? f.a * b.value / 100 : b.value / 100, f.a = d(f.a), e(a, f);
                    },
                    ...
                    mix: function(a, b, c) {
                        ...
                        var d = c.value / 100, e = 2 * d - 1, f = a.toHSL().a - b.toHSL().a, g = ((e * f == -1 ? e : (e + f) / (1 + e * f)) + 1) / 2, h = 1 - g, k = [
                            a.rgb[0] * g + b.rgb[0] * h,
                            a.rgb[1] * g + b.rgb[1] * h,
                            a.rgb[2] * g + b.rgb[2] * h
        ...
        24: [
            function(a, b, c) {
                b.exports = function(b) {
                    var c = a('../tree/quoted'), d = a('../tree/url'), e = a('../utils'), f = a('./function-registry'), g = function(a, b) {
                        return new d(b, a.index, a.currentFileInfo).eval(a.context);
                    }, h = a('../logger');
                    f.add('data-uri', function(a, f) {
                        f || (f = a, a = null);
                        var i = a && a.value, j = f.value, k = this.currentFileInfo, l = k.rewriteUrls ? k.currentDirectory : k.entryPath, m = j.indexOf('#'), n = '';
        ...
        28: [
            function(a, b, c) {
                b.exports = function(b) {
                    ...
                    return a('./boolean'), a('./default'), a('./color'), a('./color-blending'), a('./data-uri')(b), a('./list'), a('./math'), a('./number'), a('./string'), a('./svg')(b), a('./types'), c;
                };
            },
            {
                './boolean': 21,
        ...
        29: [
            function(a, b, c) {
                var d = a('../tree/comment'), e = a('../tree/dimension'), f = a('../tree/declaration'), g = a('../tree/expression'), h = a('../tree/ruleset'), i = a('../tree/selector'), j = a('../tree/element'), k = a('./function-registry'), l = function(a) {
                ...
                k.addMultiple({
                    ...
                    each: function(a, b) {
                        var c, g, k = [];
                        g = a.value ? Array.isArray(a.value) ? a.value : [
                            a.value
                        ] : a.ruleset ? a.ruleset.rules : a.rules ? a.rules : Array.isArray(a) ? a : [
                            a
                        ];
                        var l = '@value', m = '@key', n = '@index';
        ...
        32: [
            function(a, b, c) {
                var d = a('../tree/dimension'), e = a('../tree/anonymous'), f = a('./function-registry'), g = a('./math-helper.js'), h = function(a, b) {
        ...
        33: [
            function(a, b, c) {
                var d = a('../tree/quoted'), e = a('../tree/anonymous'), f = a('../tree/javascript'), g = a('./function-registry');
                g.addMultiple({
                    e: function(a) {
        ...
        34: [
            function(a, b, c) {
                b.exports = function(b) {
                    var c = a('../tree/dimension'), d = a('../tree/color'), e = a('../tree/expression'), f = a('../tree/quoted'), g = a('../tree/url'), h = a('./function-registry');
        ...
        35: [
            function(a, b, c) {
                var d = a('../tree/keyword'), e = a('../tree/detached-ruleset'), f = a('../tree/dimension'), g = a('../tree/color'), h = a('../tree/quoted'), i = a('../tree/anonymous'), j = a('../tree/url'), k = a('../tree/operation'), l = a('./function-registry'), m = function(a, b) {
        ...
        36: [
            function(a, b, c) {
                var d = a('./contexts'), e = a('./parser/parser'), f = a('./less-error'), g = a('./utils'), h = ('undefined' == typeof Promise ? a('promise') : Promise, a('./logger'));
                b.exports = function(a) {
                    ...
                    return b.prototype.push = function(b, c, i, j, k) {
                        var l = this, m = this.context.pluginManager.Loader;
                        this.queue.push(b);
        ...
        37: [
            function(a, b, c) {
                b.exports = function(b, c) {
                    ...
                    for(var m in j.tree)if (i = j.tree[m], 'function' == typeof i) l[m.toLowerCase()] = k(i);
                    else {
            ...
            function(a, b, c) {
                var d = a('./utils'), e = b.exports = function(a, b, c) {
                    ...
                    if (this.message = a.message, this.stack = a.stack, b && e) {
                        var f = b.contents[e], g = d.getLocation(a.index, f), h = g.line, i = g.column, j = a.call && d.getLocation(a.call, f).line, k = f ? f.split('\n') : '';
                        ...
                        this.callLine = j + 1, this.callExtract = k[j], this.extract = [
                            k[this.line - 2],
                            k[this.line - 1],
                            k[this.line]
                        ];
        ...
        41: [
            function(a, b, c) {
                var d, e = a('./contexts'), f = a('./parser/parser'), g = a('./plugin-manager'), h = a('./less-error'), i = a('./utils');
            ...
            function(a, b, c) {
                b.exports = function(a, b) {
                    ...
                    for(h = 0; h < m; h++)if (j = a.charCodeAt(h), !(j >= 97 && j <= 122 || j < 34)) switch(j){
                        ...
                        case 47:
                            if (o || h == m - 1) continue;
                            if (k = a.charCodeAt(h + 1), 47 == k) for(h += 2; h < m && (k = a.charCodeAt(h), !(k <= 13) || 10 != k && 13 != k); h++);
                            else if (42 == k) {
            ...
            function(a, b, c) {
                ...
                b.exports = function() {
                    ...
                    return k.save = function() {
                        ...
                        var d, e = '', f = null, g = !1, h = 0, i = [], j = [], l = b.length, m = k.i, n = k.i, o = k.i, p = !0;
        ...
        44: [
            function(a, b, c) {
                var d = a('../less-error'), e = a('../tree'), f = a('../visitors'), g = a('./parser-input'), h = a('../utils'), i = a('../functions/function-registry'), j = function k(a, b, c) {
                    function j(a, e) {
                        throw new d({
                            index: q.i,
                            filename: c.filename,
                        ...
                        parsers: p = {
                            ...
                            entities: {
                                ...
                                customFuncCall: function(a) {
                                    ...
                                    function c() {
                                        return [
                                            l(p.condition, 'expected condition')
                                        ];
                                    }
                                    return ({
                                        alpha: b(p.ieAlpha, !0),
                                ...
                                color: function() {
                                    var a;
                                    if ('#' === q.currentChar() && (a = q.$re(/^#([A-Fa-f0-9]{8}|[A-Fa-f0-9]{6}|[A-Fa-f0-9]{3,4})/))) return new e.Color(a[1], void 0, a[0]);
                                },
                            ...
                            extend: function(a) {
                                ...
                                if (q.$str(a ? '&:extend(' : ':extend(')) {
                                    do {
                                        for(f = null, b = null; !(f = q.$re(/^(all)(?=\s*(\)|,))/)) && (d = this.element());)b ? b.push(d) : b = [
                                            d
                                        ];
                                        f = f && f[1], b || j('Missing target selector for :extend().'), h = new e.Extend(new e.Selector(b), f, i, c), g ? g.push(h) : g = [
                                            h
                                        ];
                                    }while (q.$char(','))
                                    return l(/^\)/), a && l(/^;/), g;
                            ...
                            mixin: {
                                call: function(a, b) {
                                    var d, f, g, h, i = q.currentChar(), j = !1, k = q.i;
                                    if ('.' === i || '#' === i) {
                                ...
                                elements: function() {
                                    for(var a, b, d, f, g, h = /^[#.](?:[\w-]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+/;;){
                                        ...
                                        f = new e.Element(d, b, !1, g, c), a ? a.push(f) : a = [
                                            f
                                        ], d = q.$char('>');
                                    }
                                    return a;
                                ...
                                args: function(a) {
                                    var b, c, d, f, g, h, i, k = p.entities, l = {
                                        args: null,
                                        variadic: !1
                                    }, m = [], n = [], o = [], r = !0;
                                    for(q.save();;){
                                        ...
                                        var s = null;
                                        if (a ? h.value && 1 == h.value.length && (s = h.value[0]) : s = h, s && (s instanceof e.Variable || s instanceof e.Property)) if (q.$char(':')) {
                            ...
                            selector: function(a) {
                                ...
                                for(a = a !== !1; (a && (d = this.extend()) || a && (i = q.$str('when')) || (g = this.element())) && (i ? k = l(this.conditions, 'expected condition') : k ? j('CSS guard can only be used at the end of selector') : d ? h = h ? h.concat(d) : d : (h && j('Extend can only be used at the end of selector'), f = q.currentChar(), b ? b.push(g) : b = [
                                    g
                                ], g = null), '{' !== f && '}' !== f && ';' !== f && ',' !== f && ')' !== f););
                            ...
                            selectors: function() {
                                for(var a, b;;){
                                    ...
                                    if (b ? b.push(a) : b = [
                                        a
                                    ], q.commentStore.length = 0, a.condition && b.length > 1 && j('Guards are only currently allowed on a single selector.'), !q.$char(',')) break;
                            ...
                            declaration: function() {
                                var a, b, d, f, g, h, i = q.i, j = q.currentChar();
                                if ('.' !== j && '#' !== j && '&' !== j && ':' !== j) if (q.save(), a = this.variable() || this.ruleProperty()) {
                            ...
                            permissiveValue: function(a) {
                                ...
                                if (!b()) {
                                    ...
                                    if (q.save(), h = q.$parseUntil(i)) {
                                        ...
                                        var m;
                                        for(d = 0; d < h.length; d++)if (m = h[d], Array.isArray(m)) l.push(new e.Quoted(m[0], m[1], !0, k, c));
                                        else {
                            ...
                            mediaFeature: function() {
                                ...
                                q.save();
                                do a = d.keyword() || d.variable() || d.mixinLookup(), a ? f.push(a) : q.$char('(') && (b = this.property(), a = this.value(), q.$char(')') ? b && a ? f.push(new e.Paren(new e.Declaration(b, a, null, null, q.i, c, !0))) : a ? f.push(new e.Paren(a)) : j('badly formed media feature definition') : j("Missing closing ')'", 'Parse'));
                                while (a)
                            ...
                            sub: function() {
                                var a, b;
                                return q.save(), q.$char('(') ? (a = this.addition(), a && q.$char(')') ? (q.forget(), b = new e.Expression([
                                    a
                                ]), b.parens = !0, b) : void q.restore("Expected ')'")) : void q.restore();
                            },
                            multiplication: function() {
                                ...
                                if (a = this.operand()) {
                                    for(f = q.isWhitespace(-1);;){
                                        ...
                                        q.forget(), a.parensInOp = !0, b.parensInOp = !0, d = new e.Operation(c, [
                                            d || a,
                                            b
                                        ], f), f = q.isWhitespace(-1);
                                    }
                                    return d || a;
                                }
                            },
                            addition: function() {
                                ...
                                if (a = this.multiplication()) {
                                    for(f = q.isWhitespace(-1);;){
                                        ...
                                        a.parensInOp = !0, b.parensInOp = !0, d = new e.Operation(c, [
                                            d || a,
                                            b
                                        ], f), f = q.isWhitespace(-1);
                                    }
                            ...
                            atomicCondition: function(a) {
                                ...
                                var c, d, f, g, h = this.entities, i = q.i;
                            ...
                            expression: function() {
                                var a, b, c = [], d = q.i;
                                do a = this.comment(), a ? c.push(a) : (a = this.addition() || this.entity(), a && (c.push(a), q.peek(/^\/[\/*]/) || (b = q.$char('/'), b && c.push(new e.Anonymous(b, d)))));
                                while (a)
                ...
                b.exports = function(a) {
                    ...
                    return b.prototype.removeBasepath = function(a) {
                        ...
                        if (a) {
                            ...
                            if (e = a.split('\n'), g = e[e.length - 1], b && b.filename) if (d) for(i = 0; i < e.length; i++)this._sourceMapGenerator.addMapping({
                                generated: {
                        ...
                        if (this._sourceMapGenerator = new this._sourceMapGeneratorConstructor({
                            ...
                            for(var b in this._contentsMap)if (this._contentsMap.hasOwnProperty(b)) {
            ...
            function(a, b, c) {
                ...
                b.exports = function(a, b) {
                    ...
                    'object' != typeof g || Array.isArray(g) || (g = Object.keys(g).map(function(a) {
                        var b = g[a];
                        return b instanceof f.Value || (b instanceof f.Expression || (b = new f.Expression([
                            b
                        ])), b = new f.Value([
                            b
                    ...
                    if (b.pluginManager) {
                        ...
                        for(var m = 0; m < 2; m++)for(j.first(); i = j.get();)i.isPreEvalVisitor ? 0 !== m && l.indexOf(i) !== -1 || (l.push(i), i.run(a)) : 0 !== m && k.indexOf(i) !== -1 || (i.isPreVisitor ? k.unshift(i) : k.push(i));
                    }
                    c = a.eval(h);
                    for(var m = 0; m < k.length; m++)k[m].run(c);
                    if (b.pluginManager) for(j.first(); i = j.get();)k.indexOf(i) === -1 && l.indexOf(i) === -1 && i.run(c);
                    return c;
                };
            },
            {
        ...
        52: [
            function(a, b, c) {
                var d = a('./node'), e = a('./selector'), f = a('./ruleset'), g = a('./anonymous'), h = function(a, b, c, f, h, i, j, k) {
                    var l;
                    if (this.name = a, this.value = b instanceof d ? b : b ? new g(b) : b, c) {
                        for(Array.isArray(c) ? this.rules = c : (this.rules = [
                            c
                        ], this.rules[0].selectors = new e([], null, null, f, h).createEmptySelectors()), l = 0; l < this.rules.length; l++)this.rules[l].allowImports = !0;
                ...
                h.prototype = new d(), h.prototype.type = 'AtRule', h.prototype.accept = function(a) {
                    ...
                    return b = a.mediaPath, c = a.mediaBlocks, a.mediaPath = [], a.mediaBlocks = [], d && (d = d.eval(a)), e && (e = [
                        e[0].eval(a)
                    ], e[0].root = !0), a.mediaPath = b, a.mediaBlocks = c, new h(this.name, d, e, this.getIndex(), this.fileInfo(), this.debugInfo, this.isRooted, this.visibilityInfo());
        ...
        54: [
            function(a, b, c) {
                var d = a('./node'), e = a('./anonymous'), f = a('../functions/function-caller'), g = function(a, b, c, d) {
        ...
        55: [
            function(a, b, c) {
                ...
                var f = a('./node'), g = a('../data/colors'), h = function(a, b, c) {
                    var d = this;
                    Array.isArray(a) ? this.rgb = a : a.length >= 6 ? (this.rgb = [], a.match(/.{2}/g).map(function(a, b) {
                        b < 3 ? d.rgb.push(parseInt(a, 16)) : d.alpha = parseInt(a, 16) / 255;
                    })) : (this.rgb = [], a.split('').map(function(a, b) {
                        b < 3 ? d.rgb.push(parseInt(a + a, 16)) : d.alpha = parseInt(a + a, 16) / 255;
                    })), this.alpha = this.alpha || ('number' == typeof b ? b : 1), 'undefined' != typeof c && (this.value = c);
                };
                h.prototype = new f(), h.prototype.type = 'Color', h.prototype.luma = function() {
                    var a = this.rgb[0] / 255, b = this.rgb[1] / 255, c = this.rgb[2] / 255;
                    return a = a <= 0.03928 ? a / 12.92 : Math.pow((a + 0.055) / 1.055, 2.4), b = b <= 0.03928 ? b / 12.92 : Math.pow((b + 0.055) / 1.055, 2.4), c = c <= 0.03928 ? c / 12.92 : Math.pow((c + 0.055) / 1.055, 2.4), 0.2126 * a + 0.7152 * b + 0.0722 * c;
                }, h.prototype.genCSS = function(a, b) {
                    b.add(this.toCSS(a));
                }, h.prototype.toCSS = function(a, b) {
                    var c, e, f, g = a && a.compress && !b, h = [];
                    if (e = this.fround(a, this.alpha), this.value) if (0 === this.value.indexOf('rgb')) e < 1 && (f = 'rgba');
                    else {
                    ...
                    if (g.hasOwnProperty(c) ? b = new h(g[c].slice(1)) : 'transparent' === c && (b = new h([
                        0,
                        0,
                        0
                    ], 0)), b) return b.value = a, b;
                }, b.exports = h;
            },
            {
                '../data/colors': 14,
        ...
        60: [
            function(a, b, c) {
                ...
                var e = a('./node'), f = a('./value'), g = a('./keyword'), h = a('./anonymous'), i = a('../constants').Math, j = function(a, b, c, d, g, i, j, k) {
                    this.name = a, this.value = b instanceof e ? b : new f([
                        b ? new h(b) : null
                    ]), this.important = c ? ' ' + c.trim() : '', this.merge = d, this._index = g, this._fileInfo = i, this.inline = j || !1, this.variable = void 0 !== k ? k : a.charAt && '@' === a.charAt(0), this.allowRoot = !0, this.setParent(this.value, this);
                };
                j.prototype = new e(), j.prototype.type = 'Declaration', j.prototype.genCSS = function(a, b) {
                    ...
                    var b, c, e = !1, f = this.name, h = this.variable;
                    ...
                    try {
                        ...
                        var k = this.important, l = a.importantScope.pop();
        ...
        62: [
            function(a, b, c) {
                var d = a('./node'), e = a('../data/unit-conversions'), f = a('./unit'), g = a('./color'), h = function(a, b) {
                    if (this.value = parseFloat(a), isNaN(this.value)) throw new Error('Dimension is not a number.');
                    this.unit = b && b instanceof f ? b : new f(b ? [
                        b
                ...
                h.prototype = new d(), h.prototype.type = 'Dimension', h.prototype.accept = function(a) {
                    ...
                    if ('+' === b || '-' === b) if (0 === e.numerator.length && 0 === e.denominator.length) e = c.unit.clone(), this.unit.backupUnit && (e.backupUnit = this.unit.backupUnit);
        ...
        63: [
            function(a, b, c) {
                var d = a('./node'), e = a('./paren'), f = a('./combinator'), g = function(a, b, c, d, e, g) {
        ...
        64: [
            function(a, b, c) {
                var d = a('./node'), e = a('./paren'), f = a('./comment'), g = a('./dimension'), h = a('../constants').Math, i = function(a, b) {
                ...
                i.prototype = new d(), i.prototype.type = 'Expression', i.prototype.accept = function(a) {
                    ...
                    var b, c = a.isMathOn(), d = this.parens && (a.math !== h.STRICT_LEGACY || !this.parensInOp), f = !1;
        ...
        65: [
            function(a, b, c) {
                var d = a('./node'), e = a('./selector'), f = function g(a, b, c, d, e) {
                    switch(this.selector = a, this.option = b, this.object_id = g.next_id++, this.parent_ids = [
                        this.object_id
                    ], this._index = c, this._fileInfo = d, this.copyVisibilityInfo(e), this.allowRoot = !0, b){
                        case 'all':
        ...
        66: [
            function(a, b, c) {
                var d = a('./node'), e = a('./media'), f = a('./url'), g = a('./quoted'), h = a('./ruleset'), i = a('./anonymous'), j = a('../utils'), k = a('../less-error'), l = function(a, b, c, d, e, f) {
                ...
                l.prototype = new d(), l.prototype.type = 'Import', l.prototype.accept = function(a) {
                    ...
                    var b = this.path.eval(a), c = this._fileInfo;
                    if (!(b instanceof f)) {
                        var d = b.value;
        ...
        68: [
            function(a, b, c) {
                var d = a('./js-eval-node'), e = a('./dimension'), f = a('./quoted'), g = a('./anonymous'), h = function(a, b, c, d) {
                ...
                h.prototype = new d(), h.prototype.type = 'JavaScript', h.prototype.eval = function(a) {
                    var b = this.evaluateJavaScript(this.expression, a), c = typeof b;
            ...
            function(a, b, c) {
                ...
                f.prototype = new d(), f.prototype.evaluateJavaScript = function(a, b) {
                    ...
                    try {
                        ...
                        throw {
                            message: "JavaScript evaluation error: '" + g1.name + ': ' + g1.message.replace(/["]/g, "'") + "'",
                            filename: this.fileInfo().filename,
                            index: this.getIndex()
                        };
                    }
        ...
        71: [
            function(a, b, c) {
                var d = a('./ruleset'), e = a('./value'), f = a('./selector'), g = a('./anonymous'), h = a('./expression'), i = a('./atrule'), j = a('../utils'), k = function(a, b, c, g, h) {
                    ...
                    this.features = new e(b), this.rules = [
                        new d(i, a)
                    ], this.rules[0].allowImports = !0, this.copyVisibilityInfo(h), this.allowRoot = !0, this.setParent(i, this), this.setParent(this.features, this), this.setParent(this.rules, this);
                };
                k.prototype = new i(), k.prototype.type = 'Media', k.prototype.isRulesetLike = function() {
                    ...
                    return this.debugInfo && (this.rules[0].debugInfo = this.debugInfo, b.debugInfo = this.debugInfo), b.features = this.features.eval(a), a.mediaPath.push(b), a.mediaBlocks.push(b), this.rules[0].functionRegistry = a.frames[0].functionRegistry.inherit(), a.frames.unshift(this.rules[0]), b.rules = [
                        this.rules[0].eval(a)
                    ], a.frames.shift(), a.mediaPath.pop(), 0 === a.mediaPath.length ? b.evalTop(a) : b.evalNested(a);
                    ...
                    var b, c, f = a.mediaPath.concat([
                        this
                    ]);
                    for(b = 0; b < f.length; b++)c = f[b].features instanceof e ? f[b].features.value : f[b].features, f[b] = Array.isArray(c) ? c : [
                        c
                    ];
                    ...
                    for(var b = [], c = this.permute(a.slice(1)), d = 0; d < c.length; d++)for(var e = 0; e < a[0].length; e++)b.push([
                        a[0][e]
                    ].concat(c[d]));
                    return b;
        ...
        72: [
            function(a, b, c) {
                var d = a('./node'), e = a('./selector'), f = a('./mixin-definition'), g = a('../functions/default'), h = function(a, b, c, d, f) {
                ...
                h.prototype = new d(), h.prototype.type = 'MixinCall', h.prototype.accept = function(a) {
                    ...
                    var c, d, e, h, i, j, k, l, m, n, o, p, q, r, s, t = [], u = [], v = !1, w = [], x = [], y = -1, z = 0, A = 1, B = 2;
                    for(this.selector = this.selector.eval(a), j = 0; j < this.arguments.length; j++)if (h = this.arguments[j], i = h.value.eval(a), h.expand && Array.isArray(i.value)) for(i = i.value, k = 0; k < i.length; k++)t.push({
                        value: i[k]
                    });
                    else t.push({
                        name: h.name,
        ...
        73: [
            function(a, b, c) {
                var d = a('./selector'), e = a('./element'), f = a('./ruleset'), g = a('./declaration'), h = a('./detached-ruleset'), i = a('./expression'), j = a('../contexts'), k = a('../utils'), l = function(a, b, c, f, g, h, i) {
                    this.name = a || 'anonymous mixin', this.selectors = [
                        new d([
                            new e(null, a, !1, this._index, this._fileInfo)
                        ])
                    ], this.params = b, this.condition = f, this.variadic = g, this.arity = b.length, this.rules = c, this._lookups = {};
                    var j = [];
                ...
                l.prototype = new f(), l.prototype.type = 'MixinDefinition', l.prototype.evalFirst = !0, l.prototype.accept = function(a) {
                    ...
                    var e, l, m, n, o, p, q, r, s = new f(null, null), t = k.copyArray(this.params), u = 0;
                    if (b.frames && b.frames[0] && b.frames[0].functionRegistry && (s.functionRegistry = b.frames[0].functionRegistry.inherit()), b = new j.Eval(b, [
                        s
                    ].concat(b.frames)), c) {
                        for(c = k.copyArray(c), u = c.length, m = 0; m < u; m++)if (l = c[m], p = l && l.name) {
                            for(q = !1, n = 0; n < t.length; n++)if (!d[n] && p === t[n].name) {
                    ...
                    for(r = 0, m = 0; m < t.length; m++)if (!d[m]) {
                        if (l = c && c[r], p = t[m].name) if (t[m].variadic) {
                    ...
                    }) : this.rules, b = new l(this.name, this.params, a, this.condition, this.variadic, this.frames);
                    return b;
                }, l.prototype.eval = function(a) {
                    ...
                    var d, e, h = [], l = this.frames ? this.frames.concat(a.frames) : a.frames, m = this.evalParams(a, new j.Eval(a, l), b, h);
                    return m.prependRule(new g('@arguments', new i(h).eval(a))), d = k.copyArray(this.rules), e = new f(null, d), e.originalRuleset = this, e = e.eval(new j.Eval(a, [
                        this,
                        m
                    ].concat(l))), c && (e = e.makeImportant()), e;
                }, l.prototype.matchCondition = function(a, b) {
                    return !(this.condition && !this.condition.eval(new j.Eval(b, [
                        this.evalParams(b, new j.Eval(b, this.frames ? this.frames.concat(b.frames) : b.frames), a, [])
                    ].concat(this.frames || []).concat(b.frames))));
        ...
        74: [
            function(a, b, c) {
                var d = a('./node'), e = a('./variable'), f = a('./ruleset'), g = a('./selector'), h = function(a, b, c, d, e) {
                ...
                h.prototype = new d(), h.prototype.type = 'NamespaceValue', h.prototype.eval = function(a) {
                    ...
                    for(b = 0; b < this.lookups.length; b++){
                        if (c = this.lookups[b], Array.isArray(d) && (d = new f([
                            new g()
                        ], d)), '' === c) d = d.lastDeclaration();
                        else if ('@' === c.charAt(0)) {
        ...
        75: [
            function(a, b, c) {
                ...
                g.prototype = new d(), g.prototype.type = 'Negative', g.prototype.genCSS = function(a, b) {
                    ...
                    return a.isMathOn() ? new e('*', [
                        new f(-1),
                        this.value
                    ]).eval(a) : new g(this.value.eval(a));
                }, b.exports = g;
            },
            {
                './dimension': 62,
        ...
        77: [
            function(a, b, c) {
                var d = a('./node'), e = a('./color'), f = a('./dimension'), g = a('../constants').Math, h = function(a, b, c) {
                ...
                h.prototype = new d(), h.prototype.type = 'Operation', h.prototype.accept = function(a) {
                    ...
                    var b, c = this.operands[0].eval(a), d = this.operands[1].eval(a);
                    if (a.isMathOn(this.op)) {
                        if (b = './' === this.op ? '/' : this.op, c instanceof f && d instanceof e && (c = c.toColor()), d instanceof f && c instanceof e && (d = d.toColor()), !c.operate) {
                            if (c instanceof h && '/' === c.op && a.math === g.PARENS_DIVISION) return new h(this.op, [
                                c,
                                d
                            ], this.isSpaced);
                            throw {
        ...
        81: [
            function(a, b, c) {
                var d = a('./node'), e = a('./declaration'), f = a('./keyword'), g = a('./comment'), h = a('./paren'), i = a('./selector'), j = a('./element'), k = a('./anonymous'), l = a('../contexts'), m = a('../functions/function-registry'), n = a('../functions/default'), o = a('./debug-info'), p = a('../utils'), q = function(a, b, c, d) {
                ...
                q.prototype = new d(), q.prototype.type = 'Ruleset', q.prototype.isRuleset = !0, q.prototype.isRulesetLike = function() {
                    ...
                    if (this.selectors && (c = this.selectors.length)) {
                        for(b = new Array(c), n.error({
                            ...
                            for(var j = 0; j < f.elements.length; j++)if (f.elements[j].isVariable) {
                                h = !0;
                                break;
                            }
                        ...
                        if (h) {
                            ...
                            this.parse.parseNode(k.join(','), [
                                'selectors'
                            ], b[0].getIndex(), b[0].fileInfo(), function(a, c) {
                                c && (b = p.flattenArray(c));
                            });
                        }
                        n.reset();
                    } else i = !0;
                    var l, o, r = this.rules ? p.copyArray(this.rules) : null, s = new q(b, r, this.strictImports, this.visibilityInfo());
                    ...
                    for(g = 0; l = v[g]; g++)'MixinCall' === l.type ? (r = l.eval(a).filter(function(a) {
                        ...
                        g,
                        1
                    ].concat(r)), g += r.length - 1, s.resetCache()) : 'VariableCall' === l.type && (r = l.eval(a).rules.filter(function(a) {
                        return !(a instanceof e && a.variable);
                    }), v.splice.apply(v, [
                        g,
                        1
                    ].concat(r)), g += r.length - 1, s.resetCache());
                    for(g = 0; l = v[g]; g++)l.evalFirst || (v[g] = l = l.eval ? l.eval(a) : l);
                    for(g = 0; l = v[g]; g++)if (l instanceof q && l.selectors && 1 === l.selectors.length && l.selectors[0] && l.selectors[0].isJustParentSelector()) {
                        v.splice(g--, 1);
                        for(var j = 0; o = l.rules[j]; j++)o instanceof d && (o.copyVisibilityInfo(l.visibilityInfo()), o instanceof e && o.variable || v.splice(++g, 0, o));
                    }
                    if (t.shift(), u.shift(), a.mediaBlocks) for(g = w; g < a.mediaBlocks.length; g++)a.mediaBlocks[g].bubbleSelectors(b);
                    return s;
                }, q.prototype.evalImports = function(a) {
                    var b, c, d = this.rules;
                    if (d) for(b = 0; b < d.length; b++)'Import' === d[b].type && (c = d[b].eval(a), c && (c.length || 0 === c.length) ? (d.splice.apply(d, [
                        b,
                        1
                    ].concat(c)), b += c.length - 1) : d.splice(b, 1, c), this.resetCache());
                    ...
                    function b(a) {
                        return a.value instanceof k && !a.parsed ? ('string' == typeof a.value.value ? this.parse.parseNode(a.value.value, [
                            'value',
                            'important'
                        ], a.value.getIndex(), a.fileInfo(), function(b, c) {
                    ...
                    return g in this._lookups ? this._lookups[g] : (this.rulesets().forEach(function(g) {
                        if (g !== b) {
                            for(var h = 0; h < g.selectors.length; h++)if (d = a.match(g.selectors[h])) {
                    ...
                    var k, l = a.compress ? '' : Array(a.tabLevel + 1).join('  '), m = a.compress ? '' : Array(a.tabLevel).join('  '), n = 0, p = 0;
                    ...
                    function e(a, b) {
                        var c, d;
                        return c = new j(null, a, b.isVariable, b._index, b._fileInfo), d = new i([
                            c
                        ]);
                    }
                    function f(a, b, c, d) {
                    ...
                    function k(a, b) {
                        var c, d;
                        if (0 !== a.length) {
                            if (0 === b.length) return void b.push([
                                new i(a)
                            ]);
                    ...
                    function l(a, b, c) {
                        ...
                        for(q = [], r = [
                            []
                        ], n = 0; u = c.elements[n]; n++)if ('&' !== u.value) {
                            var y = m(u);
                            if (null != y) {
                                k(q, r);
                                var z, A = [], B = [];
                            ...
                            for(x = !0, s = [], k(q, r), o = 0; o < r.length; o++)if (t = r[o], 0 === b.length) t.length > 0 && t[0].elements.push(new j(u.combinator, '', u.isVariable, u._index, u._fileInfo)), s.push(t);
        ...
        82: [
            function(a, b, c) {
                ...
                g.prototype = new d(), g.prototype.type = 'Selector', g.prototype.accept = function(a) {
                    ...
                    return a ? ('string' == typeof a && this.parse.parseNode(a, [
                        'selector'
                    ], this._index, this._fileInfo, function(b, c) {
                        if (b) throw new f({
                            index: b.index,
                            message: b.message
                    ...
                    var a = new e('', '&', !1, this._index, this._fileInfo), b = [
                        new g([
                            a
        ...
        85: [
            function(a, b, c) {
                ...
                var e = a('./node'), f = function(a, b, c, d) {
                    this.value = a, this._index = b, this._fileInfo = c, this.isEvald = d;
                };
                f.prototype = new e(), f.prototype.type = 'Url', f.prototype.accept = function(a) {
                    this.value = a.visit(this.value);
                    ...
                    if (!this.isEvald && (b = this.fileInfo() && this.fileInfo().rootpath, 'string' == typeof b && 'string' == typeof c.value && a.pathRequiresRewrite(c.value) ? (c.quote || (b = d(b)), c.value = a.rewritePath(c.value, b)) : c.value = a.normalizePath(c.value), a.urlArgs && !c.value.match(/^\s*data:/))) {
                        var e = c.value.indexOf('?') === -1 ? '?' : '&', g = e + a.urlArgs;
        ...
        87: [
            function(a, b, c) {
                var d = a('./node'), e = a('./variable'), f = a('./ruleset'), g = a('./detached-ruleset'), h = a('../less-error'), i = function(a, b, c) {
                ...
                i.prototype = new d(), i.prototype.type = 'VariableCall', i.prototype.eval = function(a) {
                    var b, c = new e(this.variable, this.getIndex(), this.fileInfo()).eval(a), d = new h({
        ...
        88: [
            function(a, b, c) {
                var d = a('./node'), e = a('./call'), f = function(a, b, c) {
                    this.name = a, this._index = b, this._fileInfo = c;
                };
                f.prototype = new d(), f.prototype.type = 'Variable', f.prototype.eval = function(a) {
                    ...
                    if (this.evaluating = !0, b = this.find(a.frames, function(b) {
                        ...
                        if (d) {
                            ...
                            return a.inCalc ? new e('_SELF', [
                                d.value
                            ]).eval(a) : d.value.eval(a);
                        }
                    })) return this.evaluating = !1, b;
                    throw {
                        type: 'Name',
            ...
            function(a, b, c) {
                ...
                i.prototype = {
                    ...
                    doExtendChaining: function(a, b, c) {
                        ...
                        for(c = c || 0, e = 0; e < a.length; e++)for(f = 0; f < b.length; f++)j = a[e], k = b[f], j.parent_ids.indexOf(k.object_id) >= 0 || (i = [
                            k.selfSelectors[0]
                        ], g = n.findMatch(j, i), g.length && (j.hasFoundMatches = !0, j.selfSelectors.forEach(function(a) {
                            var b = k.visibilityInfo();
                            h = n.extendSelector(g, i, a, j.isVisible()), l = new d.Extend(k.selector, k.option, 0, k.fileInfo(), b), l.selfSelectors = h, h[h.length - 1].extendList = [
                                l
                            ], m.push(l), l.ruleset = k.ruleset, l.parent_ids = l.parent_ids.concat(k.parent_ids, j.parent_ids), k.firstExtendOnThisSelectorPath && (l.firstExtendOnThisSelectorPath = !0, k.ruleset.paths.push(h));
                        })));
                        if (m.length) {
                    ...
                    extendSelector: function(a, b, c, e) {
                        ...
                        for(f = 0; f < a.length; f++)i = a[f], g = b[i.pathIndex], h = new d.Element(i.initialCombinator, c.elements[0].value, c.elements[0].isVariable, c.elements[0].getIndex(), c.elements[0].fileInfo()), i.pathIndex > k && l > 0 && (m[m.length - 1].elements = m[m.length - 1].elements.concat(b[k].elements.slice(l)), l = 0, k++), j = g.elements.slice(l, i.index).concat([
                            h
                        ]).concat(c.elements.slice(1)), k === i.pathIndex && f > 0 ? m[m.length - 1].elements = m[m.length - 1].elements.concat(j) : (m = m.concat(b.slice(k, i.pathIndex)), m.push(new d.Selector(j))), k = i.endPathIndex, l = i.endPathElementIndex, l >= b[k].elements.length && (l = 0, k++);
        ...
        92: [
            function(a, b, c) {
                var d = a('../contexts'), e = a('./visitor'), f = a('./import-sequencer'), g = a('../utils'), h = function(a, b) {
                ...
                h.prototype = {
                    ...
                    onImported: function(a, b, c, d, e, f) {
                        ...
                        var g = this, h = a.options.inline, i = a.options.isPlugin, j = a.options.optional, k = e || f in g.recursionDetector;
                    ...
                    _removeDuplicateRules: function(a) {
                        if (a) {
                            ...
                            for(e = a.length - 1; e >= 0; e--)if (c = a[e], c instanceof d.Declaration) if (f[c.name]) {
                                b = f[c.name], b instanceof d.Declaration && (b = f[c.name] = [
            ...
            function(a, b, c) {
                ...
                i.prototype = {
                    visit: function(a) {
                        ...
                        var c, e = this._implementation, f = this._visitInCache[b], h = this._visitOutCache[b], i = g;
                    ...
                    flatten: function(a, b) {
                        b || (b = []);
                        var c, d, e, f, g, h;
                        for(d = 0, c = a.length; d < c; d++)if (e = a[d], void 0 !== e) if (e.splice) for(g = 0, f = e.length; g < f; g++)h = e[g], void 0 !== h && (h.splice ? h.length && this.flatten(h, b) : b.push(h));
                        else b.push(e);
                        return b;
                    }
                }, b.exports = i;
                ...
                var d = function() {
                    ...
                    function b(c, d, e, f, i) {
                        function l(c, e) {
                            ...
                            else if (a(c, k)) p = new k(function(a, b) {
                                c.then(function(b) {
                                    a(l(b, e - 1));
                                }, function(a) {
                                    b(l(a, e - 1));
                            ...
                            if (Object.getOwnPropertySymbols) for(var u = Object.getOwnPropertySymbols(c), s = 0; s < u.length; s++){
                                var v = u[s], w = Object.getOwnPropertyDescriptor(c, v);
                                (!w || w.enumerable || i) && (p[v] = l(c[v], e - 1), w.enumerable || Object.defineProperty(p, v, {
                                    enumerable: !1
                                }));
                            }
                            if (i) for(var x = Object.getOwnPropertyNames(c), s = 0; s < x.length; s++){
                                var y = x[s], w = Object.getOwnPropertyDescriptor(c, y);
                                w && w.enumerable || (p[y] = l(c[y], e - 1), Object.defineProperty(p, y, {
                                    enumerable: !1
                                }));
                            }
                            return p;
                        ...
                        var m = [], n = [], o = 'undefined' != typeof Buffer;
                    ...
                    return b.clonePrototype = function(a) {
                        if (null === a) return null;
                        var b = function() {};
                        return b.prototype = a, new b();
                    }, b.__objToStr = c, b.__isDate = d, b.__isArray = e, b.__isRegExp = f, b.__getRegExpFlags = g, b;
                }();
        ...
        101: [
            function(a, b, c) {
                ...
                function j(a, b) {
                    for(; 3 === a._65;)a = a._55;
                    return h._37 && h._37(a), 0 === a._65 ? 0 === a._40 ? (a._40 = 1, void (a._72 = b)) : 1 === a._40 ? (a._40 = 2, void (a._72 = [
                        a._72,
                        b
                    ])) : void a._72.push(b) : void k(a, b);
                }
                function k(a, b) {
                    q(function() {
