 ...
 */ (function(global1, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : (global1 = global1 || self, global1.Vue = factory());
})(this, function() {
    'use strict';
    ...
    function addHandler(el, name, value, modifiers, important, warn, range, dynamic) {
        ...
        /* istanbul ignore if */ if (warn && modifiers.prevent && modifiers.passive) {
    ...
    var TransitionGroup = {
        ...
        beforeMount: function beforeMount() {
            ...
            this._update = function(vnode, hydrating) {
                ...
                // force removing pass
                this$1.__patch__(this$1._vnode, this$1.kept, false, true // removeOnly (!important, avoids unnecessary moves)
                );
