            ...
            pub: function(targetElement, opts) {
                ...
                this.hasAlphaChannel = function() {
                    if (this.alphaChannel === 'auto') {
                        return this.format.toLowerCase() === 'any' || this.getFormat() === 'rgba' || this.alpha !== undefined || this.alphaElement !== undefined // the alpha value is redirected, so we're working with alpha channel
                        ;
                    }
                ...
                this.exposeColor = function(flags) {
                    ...
                    if (!(flags & jsc.flags.leavePreview) && this.previewElement) {
                        ...
                        if (jsc.isTextInput(this.previewElement) || jsc.isButton(this.previewElement) && !jsc.isButtonEmpty(this.previewElement) // button with text
                        ) {
