 ...
 */ (function(global1, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : global1.Vue = factory();
})(this, function() {
    'use strict';
 ...
 */ function getType(fn) {
    ...
    /*  */ /* globals MessageChannel */ var callbacks = [];
    var pending = false;
    ...
    MessageChannel.toString() === '[object MessageChannelConstructor]')) {
        ...
        /* istanbul ignore next */ macroTimerFunc = function() {
 ...
 */ function traverse(val) {
    ...
    function updateListeners(on, oldOn, add, remove$$1, vm) {
        ...
        for(name in on){
            ...
            /* istanbul ignore if */ if (isUndef(cur)) {
 ...
 */ function resolveSlots(children, context) {
    ...
    function mountComponent(vm, el, hydrating) {
        ...
        var updateComponent;
        /* istanbul ignore if */ if ("development" !== 'production' && config.performance && mark) {
    ...
    function updateChildComponent(vm, propsData, listeners, parentVnode, renderChildren) {
        ...
        var hasChildren = !!(renderChildren || vm.$options._renderChildren || parentVnode.data.scopedSlots || vm.$scopedSlots !== emptyObject // has old scoped slots
        );
   ...
   */ ASSET_TYPES.forEach(function(type) {
            Vue[type] = function(id, definition) {
                if (!definition) {
                    ...
                    /* istanbul ignore if */ if ("development" !== 'production' && type === 'component') {
 ...
 */ var emptyNode = new VNode('', {}, []);
                ...
                if (isDef(children)) {
                    ...
                    if (!elm.hasChildNodes()) {
                        ...
                        if (isDef(i = data) && isDef(i = i.domProps) && isDef(i = i.innerHTML)) {
                            if (i !== elm.innerHTML) {
                                /* istanbul ignore if */ if ("development" !== 'production' && typeof console !== 'undefined' && !hydrationBailed) {
    ...
    /*  */ function updateAttrs(oldVnode, vnode) {
        ...
        /* istanbul ignore if */ if ((isIE || isEdge) && attrs.value !== oldAttrs.value) {
    ...
    function baseSetAttr(el, key, value) {
        if (isFalsyAttrValue(value)) {
            ...
            // immediately.
            /* istanbul ignore if */ if (isIE && !isIE9 && el.tagName === 'TEXTAREA' && key === 'placeholder' && !el.__ieph) {
    ...
    function addHandler(el, name, value, modifiers, important, warn) {
        ...
        /* istanbul ignore if */ if ("development" !== 'production' && warn && modifiers.prevent && modifiers.passive) {
 ...
 */ function parse(template, options) {
        ...
        parseHTML(template, {
            ...
            chars: function chars(text) {
                ...
                /* istanbul ignore if */ if (isIE && currentParent.tag === 'textarea' && currentParent.attrsMap.placeholder === text) {
                    return;
                }
    ...
    function processSlot(el) {
        if (el.tag === 'slot') {
            ...
            if (el.tag === 'template') {
                ...
                /* istanbul ignore if */ if ("development" !== 'production' && slotScope) {
                    warn$2("the \"scope\" attribute for scoped slots have been deprecated and " + "replaced by \"slot-scope\" since 2.5. The new \"slot-scope\" attribute " + "can also be used on plain elements in addition to <template> to " + "denote scoped slots.", true);
                }
                el.slotScope = slotScope || getAndRemoveAttr(el, 'slot-scope');
            } else if (slotScope = getAndRemoveAttr(el, 'slot-scope')) {
                /* istanbul ignore if */ if ("development" !== 'production' && el.attrsMap['v-for']) {
            ...
            if (template) {
                if (typeof template === 'string') {
                    if (template.charAt(0) === '#') {
                        ...
                        /* istanbul ignore if */ if ("development" !== 'production' && !template) {
