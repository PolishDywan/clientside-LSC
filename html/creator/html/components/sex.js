        ...
        <div class="options">
            <div class="option">
                <div class="labelContainer">
                    ...
                    <div class="value">
                        {{ data.sex === 0 ? 'Kadın' : 'Erkek' }}
                    </div>
                </div>
                <div class="split">
                    <button @click="setParameter('sex', 0)" :class="isActive('sex', 0)">Kadın</button>
                    <button @click="setParameter('sex', 1)" :class="isActive('sex', 1)">Erkek</button>
                </div>
