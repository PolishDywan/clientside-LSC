Vue.component('tab-done', {
    ...
    methods: {
        ...
        importCharacter () {
            ...
            try {
                ...
                this.$refs.textarea.value = `Hatalı karakter kodu, yeniden yükleniyor...`;
                if (this.timeout) {
    ...
    template: `
        <div class="options">
            <div class="option">
                <button class="full" @click="saveCharacter" style="margin-bottom: 12px">Kaydet</button>
                <button disabled class="full danger" @click="discardCharacter">İptal</button>
            </div>
