...
let entity;
export function createPedEditCamera(pos, ent) {
    startPosition = pos;
    entity = ent;
    if (!camera) {
        const forwardVector = native.getEntityForwardVector(entity);
