mp.game.object.setLockedUnstreamedInDoorOfType(97297972, 17.2718, -1115.07519, 30.33417, false, 0.0, 0.0, 0.0);
...
mp.events.add("LSPDMainDoorOpen", ()=>{
    mp.game.object.doorControl(320433149, 434.7479, -983.2151, 30.83926, false, 0.0, 0.0, 0.0);
    mp.game.object.doorControl(-1215222675, 434.7479, -980.6184, 30.83926, false, 0.0, 0.0, 0.0);
});
mp.events.add("LSPDMainDoorClose", ()=>{
    mp.game.object.doorControl(320433149, 434.7479, -983.2151, 30.83926, true, 0.0, 0.0, 0.0);
    mp.game.object.doorControl(-1215222675, 434.7479, -980.6184, 30.83926, true, 0.0, 0.0, 0.0);
});
mp.keys.bind(0x45, false, function() {
    if (mp.gui.cursor.visible) return;
    mp.events.callRemote("OpenLSPDDoor", player);
    mp.events.callRemote("OpenLSPDMain", player);
