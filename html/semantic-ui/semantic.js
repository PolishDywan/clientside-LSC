 ...
 */ (function($, window1, document1, undefined) {
    $.site = $.fn.site = function(parameters) {
        var time = new Date().getTime(), performance = [], query = arguments[0], methodInvoked = typeof query == 'string', queryArguments = [].slice.call(arguments, 1), settings = $.isPlainObject(parameters) ? $.extend(true, {}, $.site.settings, parameters) : $.extend({}, $.site.settings), namespace = settings.namespace, error = settings.error, eventNamespace = '.' + namespace, moduleNamespace = 'module-' + namespace, $document = $(document1), $module = $document, element = this, instance = $module.data(moduleNamespace), module, returnedValue;
        module = {
            initialize: function() {
                module.instantiate();
            },
            ...
            fix: {
                console: function() {
                    ...
                    if (typeof console.group == 'undefined' || typeof console.groupEnd == 'undefined' || typeof console.groupCollapsed == 'undefined') {
                        ...
                        window1.console.group = function() {};
                        window1.console.groupEnd = function() {};
                        window1.console.groupCollapsed = function() {};
                    }
                    if (typeof console.markTimeline == 'undefined') {
                        module.verbose('Mark timeline not available, normalizing events');
                        window1.console.markTimeline = function() {};
                    }
                },
                consoleClear: function() {
                    module.debug('Disabling programmatic console clearing');
                    window1.console.clear = function() {};
                },
                requestAnimationFrame: function() {
                    module.debug('Normalizing requestAnimationFrame');
                    if (window1.requestAnimationFrame === undefined) {
                        module.debug('RequestAnimationFrame not available, normalizing event');
                        window1.requestAnimationFrame = window1.requestAnimationFrame || window1.mozRequestAnimationFrame || window1.webkitRequestAnimationFrame || window1.msRequestAnimationFrame || function(callback) {
            ...
            change: {
                setting: function(setting, value, modules, modifyExisting) {
                    modules = typeof modules === 'string' ? modules === 'all' ? settings.modules : [
                        modules
            ...
            console: function(enable) {
                if (enable) {
                    ...
                    window1.console = instance.cache.console;
                } else {
                    module.debug('Disabling console function');
                    instance.cache.console = window1.console;
                    window1.console = {
                        clear: function() {},
                        error: function() {},
                        group: function() {},
...
(function($, window1, document1, undefined) {
    'use strict';
    window1 = typeof window1 != 'undefined' && window1.Math == Math ? window1 : typeof self != 'undefined' && self.Math == Math ? self : Function('return this')();
    $.fn.form = function(parameters) {
        ...
        $allModules.each(function() {
            var $module = $(this), element = this, formErrors = [], keyHeldDown = false, // set at run-time
            $field, $group, $message, $prompt, $submit, $clear, $reset, settings, validation, metadata, selector, className, regExp, error, namespace, moduleNamespace, eventNamespace, instance, module;
            module = {
                initialize: function() {
                ...
                is: {
                    ...
                    shorthandFields: function(fields1) {
                        var fieldKeys = Object.keys(fields1), firstRule = fields1[fieldKeys[0]];
                ...
                event: {
                    field: {
                        keydown: function(event) {
                            var $field = $(this), key = event.which, isInput = $field.is(selector.input), isCheckbox = $field.is(selector.checkbox), isInDropdown = $field.closest(selector.uiDropdown).length > 0, keyCode = {
                                enter: 13,
                                escape: 27
                            };
                ...
                get: {
                    ...
                    inputEvent: function() {
                        return document1.createElement('input').oninput !== undefined ? 'input' : document1.createElement('input').onpropertychange !== undefined ? 'propertychange' : 'keyup';
                    },
                    fieldsFromShorthand: function(fields1) {
                        var fullFields = {};
                        $.each(fields1, function(name, rules) {
                    ...
                    prompt: function(rule, field) {
                        var ruleName = module.get.ruleName(rule), ancillary = module.get.ancillaryValue(rule), $field = module.get.field(field.identifier), value = $field.val(), prompt = $.isFunction(rule.prompt) ? rule.prompt(value) : rule.prompt || settings.prompt[ruleName] || settings.text.unspecifiedRule, requiresValue = prompt.search('{value}') !== -1, requiresName = prompt.search('{name}') !== -1, $label, name;
                        if (requiresValue) {
                    ...
                    settings: function() {
                        if ($.isPlainObject(parameters)) {
                            var keys = Object.keys(parameters), isLegacySettings = keys.length > 0 ? parameters[keys[0]].identifier !== undefined && parameters[keys[0]].rules !== undefined : false, ruleKeys;
                            if (isLegacySettings) {
                                // 1.x (ducktyped)
                    ...
                    fields: function(fields1) {
                        var $fields = $();
                        $.each(fields1, function(index, name) {
                    ...
                    value: function(field) {
                        var fields1 = [], results;
                        fields1.push(field);
                        results = module.get.values.call(element, fields1);
                        return results[field];
                    },
                    values: function(fields1) {
                        var $fields = $.isArray(fields1) ? module.get.fields(fields1) : $field, values = {};
                ...
                add: {
                    ...
                    fields: function(fields1) {
                        var newValidation;
                        if (fields1 && module.is.shorthandFields(fields1)) {
                            newValidation = module.get.fieldsFromShorthand(fields1);
                        } else {
                            newValidation = fields1;
                        }
                        validation = $.extend({}, validation, newValidation);
                    },
                    prompt: function(identifier, errors) {
                        var $field = module.get.field(identifier), $fieldGroup = $field.closest($group), $prompt = $fieldGroup.children(selector.prompt), promptExists = $prompt.length !== 0;
                ...
                remove: {
                    ...
                    field: function(field) {
                        var fields1 = $.isArray(field) ? field : [
                            field
                        ];
                        $.each(fields1, function(index, field) {
                ...
                set: {
                    ...
                    value: function(field, value) {
                        var fields1 = {};
                        fields1[field] = value;
                        return module.set.values.call(element, fields1);
                    },
                    values: function(fields1) {
                        if ($.isEmptyObject(fields1)) {
                            return;
                        }
                        $.each(fields1, function(key, value) {
                            var $field = module.get.field(key), $element = $field.parent(), isMultiple = $.isArray(value), isCheckbox = $element.is(selector.uiCheckbox), isDropdown = $element.is(selector.uiDropdown), isRadio = $field.is(selector.radio) && isCheckbox, fieldExists = $field.length > 0, $multipleField;
                            if (fieldExists) {
...
(function($, window1, document1, undefined) {
    ...
    $.fn.accordion = function(parameters) {
        var $allModules = $(this), time = new Date().getTime(), performance = [], query = arguments[0], methodInvoked = typeof query == 'string', queryArguments = [].slice.call(arguments, 1), requestAnimationFrame = window1.requestAnimationFrame || window1.mozRequestAnimationFrame || window1.webkitRequestAnimationFrame || window1.msRequestAnimationFrame || function(callback) {
            setTimeout(callback, 0);
        }, returnedValue;
        $allModules.each(function() {
            ...
            module = {
                ...
                observeChanges: function() {
                    if ('MutationObserver' in window1) {
    ...
    $.fn.checkbox = function(parameters) {
        ...
        $allModules.each(function() {
            ...
            module = {
                ...
                trigger: {
                    change: function() {
                        var events = document1.createEvent('HTMLEvents'), inputElement = $input[0];
                        if (inputElement) {
            ...
            module = {
                ...
                set: {
                    opacity: function(opacity) {
                        var color = $dimmer.css('background-color'), colorArray = color.split(','), isRGB = colorArray && colorArray.length == 3, isRGBA = colorArray && colorArray.length == 4;
...
(function($, window1, document1, undefined) {
    ...
    $.fn.dropdown = function(parameters) {
        var $allModules = $(this), $document = $(document1), moduleSelector = $allModules.selector || '', hasTouch = 'ontouchstart' in document1.documentElement, time = new Date().getTime(), performance = [], query = arguments[0], methodInvoked = typeof query == 'string', queryArguments = [].slice.call(arguments, 1), returnedValue;
        $allModules.each(function(elementIndex) {
            var settings = $.isPlainObject(parameters) ? $.extend(true, {}, $.fn.dropdown.settings, parameters) : $.extend({}, $.fn.dropdown.settings), className = settings.className, message = settings.message, fields1 = settings.fields, keys = settings.keys, metadata = settings.metadata, namespace = settings.namespace, regExp = settings.regExp, selector = settings.selector, error = settings.error, templates = settings.templates, eventNamespace = '.' + namespace, moduleNamespace = 'module-' + namespace, $module = $(this), $context = $(settings.context), $text = $module.find(selector.text), $search = $module.find(selector.search), $sizer = $module.find(selector.sizer), $input = $module.find(selector.input), $icon = $module.find(selector.icon), $combo = $module.prev().find(selector.text).length > 0 ? $module.prev().find(selector.text) : $module.prev(), $menu = $module.children(selector.menu), $item = $menu.find(selector.item), activated = false, itemActivated = false, internalChange = false, element = this, instance = $module.data(moduleNamespace), initialLoad, pageLostFocus, willRefocus, elementNamespace, id, selectObserver, menuObserver, module;
            module = {
                initialize: function() {
                ...
                setup: {
                    ...
                    menu: function(values) {
                        $menu.html(templates.menu(values, fields1));
                ...
                queryRemote: function(query, callback) {
                    var apiSettings = {
                        ...
                        onSuccess: function(response) {
                            var values = response[fields1.remoteValues], hasRemoteValues = $.isArray(values) && values.length > 0;
                            if (hasRemoteValues) {
                                module.remove.message();
                                module.setup.menu({
                                    values: response[fields1.remoteValues]
                                });
                            } else {
                                module.add.message(message.noResults);
                            }
                ...
                fuzzySearch: function(query, term) {
                    var termLength = term.length, queryLength = query.length;
                ...
                event: {
                    ...
                    blur: function(event) {
                        pageLostFocus = document1.activeElement === this;
                    ...
                    item: {
                        mouseenter: function(event) {
                            var $target = $(event.target), $item = $(this), $subMenu = $item.children(selector.menu), $otherMenus = $item.siblings(selector.item).children(selector.menu), hasSubMenu = $subMenu.length > 0, isBubbledEvent = $subMenu.find($target).length > 0;
                ...
                determine: {
                    ...
                    eventInModule: function(event, callback) {
                        var $target = $(event.target), inDocument = $target.closest(document1.documentElement).length > 0, inModule = $target.closest($module).length > 0;
                        callback = $.isFunction(callback) ? callback : function() {};
                    ...
                    eventOnElement: function(event, callback) {
                        var $target = $(event.target), $label = $target.closest(selector.siblingLabel), inVisibleDOM = document1.body.contains(event.target), notOnLabel = $module.find($label).length === 0, notInMenu = $target.closest($menu).length === 0;
                        callback = $.isFunction(callback) ? callback : function() {};
                ...
                get: {
                    ...
                    caretPosition: function() {
                        ...
                        } else if (document1.selection) {
                            input.focus();
                            range = document1.selection.createRange();
                    ...
                    value: function() {
                        var value = $input.length > 0 ? $input.val() : $module.data(metadata.value), isEmptyMultiselect = $.isArray(value) && value.length === 1 && value[0] === '';
                    ...
                    selectValues: function() {
                        ...
                        $module.find('option').each(function() {
                            var $option = $(this), name = $option.html(), disabled = $option.attr('disabled'), value = $option.attr('value') !== undefined ? $option.attr('value') : name;
                ...
                scrollPage: function(direction, $selectedItem) {
                    var $currentItem = $selectedItem || module.get.selectedItem(), $menu = $currentItem.closest(selector.menu), menuHeight = $menu.outerHeight(), currentScroll = $menu.scrollTop(), itemHeight = $item.eq(0).outerHeight(), itemsPerPage = Math.floor(menuHeight / itemHeight), maxScroll = $menu.prop('scrollHeight'), newScroll = direction == 'up' ? currentScroll - itemHeight * itemsPerPage : currentScroll + itemHeight * itemsPerPage, $selectableItem = $item.not(selector.unselectable), isWithinRange, $nextSelectedItem, elementIndex;
                ...
                set: {
                    ...
                    scrollPosition: function($item, forceScroll) {
                        var edgeTolerance = 5, $menu, hasActive, offset, itemHeight, itemOffset, menuOffset, menuScroll, menuHeight, abovePage, belowPage;
                    ...
                    selectedItem: function($item) {
                        var value = module.get.choiceValue($item), searchText = module.get.choiceText($item, false), text = module.get.choiceText($item, true);
                    ...
                    selected: function(value, $selectedItem) {
                        var isMultiple = module.is.multiple(), $userSelectedItem;
                ...
                add: {
                    ...
                    message: function(message) {
                        var $message = $menu.children(selector.message), html = settings.templates.message(module.add.variables(message));
                        if ($message.length > 0) {
                            $message.html(html);
                        } else {
                    ...
                    variables: function(message, term) {
                        var hasCount = message.search('{count}') !== -1, hasMaxCount = message.search('{maxCount}') !== -1, hasTerm = message.search('{term}') !== -1, values, count, query;
                ...
                remove: {
                    ...
                    label: function(value, shouldAnimate) {
                        var $labels = $module.find(selector.label), $removedLabel = $labels.filter('[data-' + metadata.value + '="' + module.escape.string(value) + '"]');
                ...
                has: {
                    ...
                    valueMatchingCase: function(value) {
                        var values = module.get.values(), hasValue = $.isArray(values) ? values && $.inArray(value, values) !== -1 : values == value;
                ...
                is: {
                    ...
                    focused: function() {
                        return document1.activeElement === $module[0];
                    },
                    focusedOnSearch: function() {
                        return document1.activeElement === $search[0];
                    },
                    ...
                    verticallyScrollableContext: function() {
                        var overflowY = $context.get(0) !== window1 ? $context.css('overflow-y') : false;
                        return overflowY == 'auto' || overflowY == 'scroll';
                    },
                    horizontallyScrollableContext: function() {
                        var overflowX = $context.get(0) !== window1 ? $context.css('overflow-X') : false;
                ...
                animate: {
                    show: function(callback, $subMenu) {
                        var $currentMenu = $subMenu || $menu, start = $subMenu ? function() {} : function() {
                            module.hideSubMenus();
                            module.hideOthers();
                            module.set.active();
                        }, transition;
                    ...
                    hide: function(callback, $subMenu) {
                        var $currentMenu = $subMenu || $menu, duration = $subMenu ? settings.duration * 0.9 : settings.duration, start = $subMenu ? function() {} : function() {
                            if (module.can.click()) {
                ...
                escape: {
                    value: function(value) {
                        var multipleValues = $.isArray(value), stringValue = typeof value === 'string', isUnparsable = !stringValue && !multipleValues, hasQuotes = stringValue && value.search(regExp.quote) !== -1, values = [];
    ...
    /* Templates */ $.fn.dropdown.settings.templates = {
        ...
        dropdown: function(select) {
            var placeholder = select.placeholder || false, values = select.values || {}, html = '';
        ...
        menu: function(response, fields1) {
            var values = response[fields1.values] || {}, html = '';
            $.each(values, function(index, option) {
                var maybeText = option[fields1.text] ? 'data-text="' + option[fields1.text] + '"' : '', maybeDisabled = option[fields1.disabled] ? 'disabled ' : '';
                html += '<div class="' + maybeDisabled + 'item" data-value="' + option[fields1.value] + '"' + maybeText + '>';
                html += option[fields1.name];
                html += '</div>';
            });
            return html;
        },
...
(function($, window1, document1, undefined) {
    ...
    $.fn.embed = function(parameters) {
        var $allModules = $(this), moduleSelector = $allModules.selector || '', time = new Date().getTime(), performance = [], query = arguments[0], methodInvoked = typeof query == 'string', queryArguments = [].slice.call(arguments, 1), returnedValue;
        $allModules.each(function() {
            var settings = $.isPlainObject(parameters) ? $.extend(true, {}, $.fn.embed.settings, parameters) : $.extend({}, $.fn.embed.settings), selector = settings.selector, className = settings.className, sources = settings.sources, error = settings.error, metadata = settings.metadata, namespace = settings.namespace, templates = settings.templates, eventNamespace = '.' + namespace, moduleNamespace = 'module-' + namespace, $window = $(window1), $module = $(this), $placeholder = $module.find(selector.placeholder), $icon = $module.find(selector.icon), $embed = $module.find(selector.embed), element = this, instance = $module.data(moduleNamespace), module;
            module = {
                initialize: function() {
                ...
                createPlaceholder: function(placeholder) {
                    var icon = module.get.icon(), url = module.get.url(), embed = module.generate.embed(url);
                ...
                generate: {
                    embed: function(url) {
                        ...
                        var source = module.get.source(), html, parameters;
...
(function($, window1, document1, undefined) {
    ...
    $.fn.modal = function(parameters) {
        var $allModules = $(this), $window = $(window1), $document = $(document1), $body = $('body'), moduleSelector = $allModules.selector || '', time = new Date().getTime(), performance = [], query = arguments[0], methodInvoked = typeof query == 'string', queryArguments = [].slice.call(arguments, 1), requestAnimationFrame = window1.requestAnimationFrame || window1.mozRequestAnimationFrame || window1.webkitRequestAnimationFrame || window1.msRequestAnimationFrame || function(callback) {
            setTimeout(callback, 0);
        }, returnedValue;
        $allModules.each(function() {
            ...
            module = {
                ...
                event: {
                    ...
                    click: function(event) {
                        ...
                        var $target = $(event.target), isInModal = $target.closest(selector.modal).length > 0, isInDOM = $.contains(document1.documentElement, event.target);
                ...
                save: {
                    focus: function() {
                        var $activeElement = $(document1.activeElement), inCurrentModal = $activeElement.closest($module).length > 0;
                        if (!inCurrentModal) {
                            $focusedElement = $(document1.activeElement).blur();
                        }
                    }
                },
                restore: {
                ...
                cacheSizes: function() {
                    ...
                    if (module.cache === undefined || modalHeight !== 0) {
                        module.cache = {
                            pageHeight: $(document1).outerHeight(),
                            width: modalWidth,
                            height: modalHeight + settings.offset,
                            scrollHeight: scrollHeight + settings.offset,
                            contextHeight: settings.context == 'body' ? $(window1).height() : $dimmable.height()
                        };
                ...
                is: {
                    ...
                    ie: function() {
                        var isIE11 = !window1.ActiveXObject && 'ActiveXObject' in window1, isIE = 'ActiveXObject' in window1;
                        return isIE11 || isIE;
                    },
                    animating: function() {
                    ...
                    modernBrowser: function() {
                        ...
                        return !(window1.ActiveXObject || 'ActiveXObject' in window1);
                    }
                },
                set: {
                    autofocus: function() {
                        var $inputs = $module.find('[tabindex], :input').filter(':visible'), $autofocus = $inputs.filter('[autofocus]'), $input = $autofocus.length > 0 ? $autofocus.first() : $inputs.first();
                        if ($input.length > 0) {
                            $input.focus();
                        }
                    },
                    ...
                    modalOffset: function() {
                        var width = module.cache.width, height = module.cache.height;
                        $module.css({
...
(function($, window1, document1, undefined) {
    ...
    $.fn.nag = function(parameters) {
        var $allModules = $(this), moduleSelector = $allModules.selector || '', time = new Date().getTime(), performance = [], query = arguments[0], methodInvoked = typeof query == 'string', queryArguments = [].slice.call(arguments, 1), returnedValue;
        $allModules.each(function() {
            var settings = $.isPlainObject(parameters) ? $.extend(true, {}, $.fn.nag.settings, parameters) : $.extend({}, $.fn.nag.settings), className = settings.className, selector = settings.selector, error = settings.error, namespace = settings.namespace, eventNamespace = '.' + namespace, moduleNamespace = namespace + '-module', $module = $(this), $close = $module.find(selector.close), $context = settings.context ? $(settings.context) : $('body'), element = this, instance = $module.data(moduleNamespace), moduleOffset, moduleHeight, contextWidth, contextHeight, contextOffset, yOffset, yPosition, timer, module, requestAnimationFrame = window1.requestAnimationFrame || window1.mozRequestAnimationFrame || window1.webkitRequestAnimationFrame || window1.msRequestAnimationFrame || function(callback) {
                setTimeout(callback, 0);
            };
            module = {
                initialize: function() {
                ...
                storage: {
                    set: function(key, value) {
                        ...
                        if (settings.storageMethod == 'localstorage' && window1.localStorage !== undefined) {
                            window1.localStorage.setItem(key, value);
                            module.debug('Value stored using local storage', key, value);
                        } else if (settings.storageMethod == 'sessionstorage' && window1.sessionStorage !== undefined) {
                            window1.sessionStorage.setItem(key, value);
                    ...
                    get: function(key, value) {
                        var storedValue;
                        if (settings.storageMethod == 'localstorage' && window1.localStorage !== undefined) {
                            storedValue = window1.localStorage.getItem(key);
                        } else if (settings.storageMethod == 'sessionstorage' && window1.sessionStorage !== undefined) {
                            storedValue = window1.sessionStorage.getItem(key);
                        } else if ($.cookie !== undefined) {
                    ...
                    remove: function(key) {
                        var options = module.get.storageOptions();
                        if (settings.storageMethod == 'localstorage' && window1.localStorage !== undefined) {
                            window1.localStorage.removeItem(key);
                        } else if (settings.storageMethod == 'sessionstorage' && window1.sessionStorage !== undefined) {
                            window1.sessionStorage.removeItem(key);
                        } else if ($.cookie !== undefined) {
...
(function($, window1, document1, undefined) {
    ...
    $.fn.popup = function(parameters) {
        var $allModules = $(this), $document = $(document1), $window = $(window1), $body = $('body'), moduleSelector = $allModules.selector || '', hasTouch = true, time = new Date().getTime(), performance = [], query = arguments[0], methodInvoked = typeof query == 'string', queryArguments = [].slice.call(arguments, 1), returnedValue;
        $allModules.each(function() {
            var settings = $.isPlainObject(parameters) ? $.extend(true, {}, $.fn.popup.settings, parameters) : $.extend({}, $.fn.popup.settings), selector = settings.selector, className = settings.className, error = settings.error, metadata = settings.metadata, namespace = settings.namespace, eventNamespace = '.' + settings.namespace, moduleNamespace = 'module-' + namespace, $module = $(this), $context = $(settings.context), $scrollContext = $(settings.scrollContext), $boundary = $(settings.boundary), $target = settings.target ? $(settings.target) : $module, $popup, $offsetParent, searchDepth = 0, triedPositions = false, openedWithTouch = false, element = this, instance = $module.data(moduleNamespace), documentObserver, elementNamespace, id, module;
            module = {
                // binds events
                initialize: function() {
                    module.debug('Initializing', $module);
                ...
                observeChanges: function() {
                    if ('MutationObserver' in window1) {
                        ...
                        documentObserver.observe(document1, {
                            childList: true,
                            subtree: true
                        });
                ...
                event: {
                    ...
                    hideGracefully: function(event) {
                        var $target = $(event.target), isInDOM = $.contains(document1.documentElement, event.target), inPopup = $target.closest(selector.popup).length > 0;
                ...
                get: {
                    ...
                    calculations: function() {
                        var $popupOffsetParent = module.get.offsetParent($popup), targetElement = $target[0], isWindow = $boundary[0] == window1, targetPosition = settings.inline || settings.popup && settings.movePopup ? $target.position() : $target.offset(), screenPosition = isWindow ? {
                            top: 0,
                            left: 0
                        } : $boundary.offset(), calculations = {}, scroll = isWindow ? {
                        ...
                        calculations.target.margin.top = settings.inline ? parseInt(window1.getComputedStyle(targetElement).getPropertyValue('margin-top'), 10) : 0;
                        calculations.target.margin.left = settings.inline ? module.is.rtl() ? parseInt(window1.getComputedStyle(targetElement).getPropertyValue('margin-right'), 10) : parseInt(window1.getComputedStyle(targetElement).getPropertyValue('margin-left'), 10) : 0;
                    ...
                    offsetParent: function($element) {
                        var element = $element !== undefined ? $element[0] : $target[0], parentNode = element.parentNode, $node = $(parentNode);
                        if (parentNode) {
    ...
    $.fn.popup.settings = {
        ...
        templates: {
            ...
            popup: function(text) {
                var html = '', escape = $.fn.popup.settings.templates.escape;
...
(function($, window1, document1, undefined) {
    'use strict';
    window1 = typeof window1 != 'undefined' && window1.Math == Math ? window1 : typeof self != 'undefined' && self.Math == Math ? self : Function('return this')();
    var global = typeof window1 != 'undefined' && window1.Math == Math ? window1 : typeof self != 'undefined' && self.Math == Math ? self : Function('return this')();
    $.fn.progress = function(parameters) {
        var $allModules = $(this), moduleSelector = $allModules.selector || '', time = new Date().getTime(), performance = [], query = arguments[0], methodInvoked = typeof query == 'string', queryArguments = [].slice.call(arguments, 1), returnedValue;
        $allModules.each(function() {
            var settings = $.isPlainObject(parameters) ? $.extend(true, {}, $.fn.progress.settings, parameters) : $.extend({}, $.fn.progress.settings), className = settings.className, metadata = settings.metadata, namespace = settings.namespace, selector = settings.selector, error = settings.error, eventNamespace = '.' + namespace, moduleNamespace = 'module-' + namespace, $module = $(this), $bar = $(this).find(selector.bar), $progress = $(this).find(selector.progress), $label = $(this).find(selector.label), element = this, instance = $module.data(moduleNamespace), animating = false, transitionEnd, module;
            module = {
                initialize: function() {
                ...
                get: {
                    text: function(templateText) {
                        var value = module.value || 0, total = module.total || 0, percent = animating ? module.get.displayPercent() : module.percent || 0, left = module.total > 0 ? total - value : 100 - percent;
                    ...
                    transitionEnd: function() {
                        var element = document1.createElement('element'), transitions = {
                    ...
                    displayPercent: function() {
                        var barWidth = $bar.width(), totalWidth = $module.width(), minDisplay = parseInt($bar.css('min-width'), 10), displayPercent = barWidth > minDisplay ? barWidth / totalWidth * 100 : module.percent;
                ...
                set: {
                    ...
                    labelInterval: function() {
                        ...
                        module.interval = setInterval(function() {
                            var isInDOM = $.contains(document1.documentElement, element);
                            if (!isInDOM) {
                                clearInterval(module.interval);
                                animating = false;
                            }
...
(function($, window1, document1, undefined) {
    ...
    $.fn.rating = function(parameters) {
        var $allModules = $(this), moduleSelector = $allModules.selector || '', time = new Date().getTime(), performance = [], query = arguments[0], methodInvoked = typeof query == 'string', queryArguments = [].slice.call(arguments, 1), returnedValue;
        $allModules.each(function() {
            var settings = $.isPlainObject(parameters) ? $.extend(true, {}, $.fn.rating.settings, parameters) : $.extend({}, $.fn.rating.settings), namespace = settings.namespace, className = settings.className, metadata = settings.metadata, selector = settings.selector, error = settings.error, eventNamespace = '.' + namespace, moduleNamespace = 'module-' + namespace, element = this, instance = $(this).data(moduleNamespace), $module = $(this), $icon = $module.find(selector.icon), initialLoad, module;
            module = {
                initialize: function() {
                ...
                setup: {
                    layout: function() {
                        var maxRating = module.get.maxRating(), html = $.fn.rating.settings.templates.icon(maxRating);
                ...
                set: {
                    rating: function(rating) {
                        var ratingIndex = rating - 1 >= 0 ? rating - 1 : 0, $activeIcon = $icon.eq(ratingIndex);
                        $module.removeClass(className.selected);
...
(function($, window1, document1, undefined) {
        ...
        $(this).each(function() {
            ...
            module = {
                ...
                event: {
                    ...
                    blur: function(event) {
                        var pageLostFocus = document1.activeElement === this, callback = function() {
                            module.cancel.query();
                            module.remove.focus();
                    ...
                    result: {
                        ...
                        click: function(event) {
                            ...
                            var $result = $(this), $title = $result.find(selector.title).eq(0), $link = $result.is('a[href]') ? $result : $result.find('a[href]').eq(0), href = $link.attr('href') || false, target = $link.attr('target') || false, title = $title.html(), // title is used for result lookup
                            value = $title.length > 0 ? $title.text() : false, results = module.get.results(), result = $result.data(metadata.result) || module.get.result(value, results), returnedValue;
                ...
                handleKeyboard: function(event) {
                    ...
                    $result = $module.find(selector.result), $category = $module.find(selector.category), $activeResult = $result.filter('.' + className.active), currentIndex = $result.index($activeResult), resultSize = $result.length, hasActiveResult = $activeResult.length > 0, keyCode = event.which, keys = {
                        backspace: 8,
                        enter: 13,
                        escape: 27,
                        upArrow: 38,
                ...
                is: {
                    ...
                    inMessage: function(event) {
                        ...
                        var $target = $(event.target), isInDOM = $.contains(document1.documentElement, event.target);
                ...
                search: {
                    local: function(searchTerm) {
                        var results = module.search.object(searchTerm, settings.content), searchHTML;
                        module.set.loading();
                    ...
                    object: function(searchTerm, source, searchFields) {
                        var results = [], exactResults = [], fuzzyResults = [], searchExp = searchTerm.toString().replace(regExp.escape, '\\$&'), matchRegExp = new RegExp(regExp.beginsWith + searchExp, 'i'), // avoid duplicates when pushing results
                ...
                parse: {
                    response: function(response, searchTerm) {
                        ...
                        if (response !== undefined) {
                            if (searchTerm !== undefined && response[fields1.results] !== undefined) {
                                module.addResults(searchHTML);
                                module.inject.id(response[fields1.results]);
                                module.write.cache(searchTerm, {
                                    html: searchHTML,
                                    results: response[fields1.results]
                                });
                                module.save.results(response[fields1.results]);
                            }
                        }
                    }
                },
                ...
                create: {
                    ...
                    id: function(resultIndex, categoryIndex) {
                        var resultID = resultIndex + 1, categoryID = categoryIndex + 1, firstCharCode, letterID, id;
                ...
                generateResults: function(response) {
                    ...
                    var template = settings.templates[settings.type], isProperObject = $.isPlainObject(response[fields1.results]) && !$.isEmptyObject(response[fields1.results]), isProperArray = $.isArray(response[fields1.results]) && response[fields1.results].length > 0, html = '';
                    if (isProperObject || isProperArray) {
                        if (settings.maxResults > 0) {
                            if (isProperObject) {
                                ...
                                response[fields1.results] = response[fields1.results].slice(0, settings.maxResults);
                            }
                        }
                        if ($.isFunction(template)) {
                            html = template(response, fields1);
                        } else {
    ...
    $.fn.search.settings = {
        ...
        templates: {
            ...
            category: function(response, fields1) {
                var html = '', escape = $.fn.search.settings.templates.escape;
                if (response[fields1.categoryResults] !== undefined) {
                    // each category
                    $.each(response[fields1.categoryResults], function(index, category) {
                        if (category[fields1.results] !== undefined && category.results.length > 0) {
                            html += '<div class="category">';
                            if (category[fields1.categoryName] !== undefined) {
                                html += '<div class="name">' + category[fields1.categoryName] + '</div>';
                            }
                            // each item inside category
                            html += '<div class="results">';
                            $.each(category.results, function(index, result) {
                                if (result[fields1.url]) {
                                    html += '<a class="result" href="' + result[fields1.url] + '">';
                                } else {
                                    html += '<a class="result">';
                                }
                                if (result[fields1.image] !== undefined) {
                                    html += '' + '<div class="image">' + ' <img src="' + result[fields1.image] + '">' + '</div>';
                                }
                                html += '<div class="content">';
                                if (result[fields1.price] !== undefined) {
                                    html += '<div class="price">' + result[fields1.price] + '</div>';
                                }
                                if (result[fields1.title] !== undefined) {
                                    html += '<div class="title">' + result[fields1.title] + '</div>';
                                }
                                if (result[fields1.description] !== undefined) {
                                    html += '<div class="description">' + result[fields1.description] + '</div>';
                                }
                                html += '' + '</div>';
                                html += '</a>';
                            });
                    ...
                    if (response[fields1.action]) {
                        html += '' + '<a href="' + response[fields1.action][fields1.actionURL] + '" class="action">' + response[fields1.action][fields1.actionText] + '</a>';
                    }
                    return html;
                }
                return false;
            },
            standard: function(response, fields1) {
                var html = '';
                if (response[fields1.results] !== undefined) {
                    // each result
                    $.each(response[fields1.results], function(index, result) {
                        if (result[fields1.url]) {
                            html += '<a class="result" href="' + result[fields1.url] + '">';
                        } else {
                            html += '<a class="result">';
...
(function($, window1, document1, undefined) {
    ...
    $.fn.shape = function(parameters) {
        var $allModules = $(this), $body = $('body'), time = new Date().getTime(), performance = [], query = arguments[0], methodInvoked = typeof query == 'string', queryArguments = [].slice.call(arguments, 1), requestAnimationFrame = window1.requestAnimationFrame || window1.mozRequestAnimationFrame || window1.webkitRequestAnimationFrame || window1.msRequestAnimationFrame || function(callback) {
            setTimeout(callback, 0);
        }, returnedValue;
        $allModules.each(function() {
            var moduleSelector = $allModules.selector || '', settings = $.isPlainObject(parameters) ? $.extend(true, {}, $.fn.shape.settings, parameters) : $.extend({}, $.fn.shape.settings), // internal aliases
            ...
            module = {
                ...
                repaint: function() {
                    ...
                    var shape = $sides[0] || document1.createElement('div'), fakeAssignment = shape.offsetWidth;
                },
                ...
                set: {
                    ...
                    currentStageSize: function() {
                        var $activeSide = $module.find('.' + settings.className.active), width = $activeSide.outerWidth(true), height = $activeSide.outerHeight(true);
                        $module.css({
                            width: width,
                            height: height
                        });
...
(function($, window1, document1, undefined) {
    ...
    $.fn.sidebar = function(parameters) {
        var $allModules = $(this), $window = $(window1), $document = $(document1), $html = $('html'), $head = $('head'), moduleSelector = $allModules.selector || '', time = new Date().getTime(), performance = [], query = arguments[0], methodInvoked = typeof query == 'string', queryArguments = [].slice.call(arguments, 1), requestAnimationFrame = window1.requestAnimationFrame || window1.mozRequestAnimationFrame || window1.webkitRequestAnimationFrame || window1.msRequestAnimationFrame || function(callback) {
            setTimeout(callback, 0);
        }, returnedValue;
        $allModules.each(function() {
            var settings = $.isPlainObject(parameters) ? $.extend(true, {}, $.fn.sidebar.settings, parameters) : $.extend({}, $.fn.sidebar.settings), selector = settings.selector, className = settings.className, namespace = settings.namespace, regExp = settings.regExp, error = settings.error, eventNamespace = '.' + namespace, moduleNamespace = 'module-' + namespace, $module = $(this), $context = $(settings.context), $sidebars = $module.children(selector.sidebar), $fixed = $context.children(selector.fixed), $pusher = $context.children(selector.pusher), $style, element = this, instance = $module.data(moduleNamespace), elementNamespace, id, currentScroll, transitionEvent, module;
            module = {
                initialize: function() {
                ...
                event: {
                    clickaway: function(event) {
                        var clickedInPusher = $pusher.find(event.target).length > 0 || $pusher.is(event.target), clickedContext = $context.is(event.target);
                        if (clickedInPusher) {
                ...
                add: {
                    inlineCSS: function() {
                        ...
                        /* IE is only browser not to create context with transforms */ /* https://www.w3.org/Bugs/Public/show_bug.cgi?id=16328 */ if (module.is.ie()) {
                            if (direction === 'left' || direction === 'right') {
                                module.debug('Adding CSS rules for animation distance', width);
                            ...
                            /* opposite sides visible forces content overlay */ style += '' + ' body.pushable > .ui.visible.left.sidebar ~ .ui.visible.right.sidebar ~ .pusher:after,' + ' body.pushable > .ui.visible.right.sidebar ~ .ui.visible.left.sidebar ~ .pusher:after {' + '   -webkit-transform: translate3d(0px, 0, 0);' + '           transform: translate3d(0px, 0, 0);' + ' }';
                        }
                        style += '</style>';
                ...
                scrollToTop: function() {
                    ...
                    currentScroll = $(window1).scrollTop();
                    $module.scrollTop(0);
                    window1.scrollTo(0, 0);
                },
                scrollBack: function() {
                    module.verbose('Scrolling back to original page position');
                    window1.scrollTo(0, currentScroll);
                },
                clear: {
                    cache: function() {
...
(function($, window1, document1, undefined) {
    ...
    $.fn.sticky = function(parameters) {
        var $allModules = $(this), moduleSelector = $allModules.selector || '', time = new Date().getTime(), performance = [], query = arguments[0], methodInvoked = typeof query == 'string', queryArguments = [].slice.call(arguments, 1), returnedValue;
        $allModules.each(function() {
            var settings = $.isPlainObject(parameters) ? $.extend(true, {}, $.fn.sticky.settings, parameters) : $.extend({}, $.fn.sticky.settings), className = settings.className, namespace = settings.namespace, error = settings.error, eventNamespace = '.' + namespace, moduleNamespace = 'module-' + namespace, $module = $(this), $window = $(window1), $scroll = $(settings.scrollContext), $container, $context, selector = $module.selector || '', instance = $module.data(moduleNamespace), requestAnimationFrame = window1.requestAnimationFrame || window1.mozRequestAnimationFrame || window1.webkitRequestAnimationFrame || window1.msRequestAnimationFrame || function(callback) {
                setTimeout(callback, 0);
            }, element = this, documentObserver, observer, module;
            module = {
                initialize: function() {
                ...
                supports: {
                    sticky: function() {
                        var $element = $('<div/>'), element = $element[0];
                ...
                get: {
                    ...
                    elementScroll: function(scroll) {
                        scroll = scroll || $scroll.scrollTop();
                        var element = module.cache.element, scrollContext = module.cache.scrollContext, delta = module.get.scrollChange(scroll), maxScroll = element.height - scrollContext.height + settings.offset, elementScroll = module.get.currentElementScroll(), possibleScroll = elementScroll + delta;
                ...
                stick: function(scroll) {
                    var cachedPosition = scroll || $scroll.scrollTop(), cache = module.cache, fits = cache.fits, sameHeight = cache.sameHeight, element = cache.element, scrollContext = cache.scrollContext, context = cache.context, offset = module.is.bottom() && settings.pushing ? settings.bottomOffset : settings.offset, scroll = {
                        top: cachedPosition + offset,
                        bottom: cachedPosition + offset + scrollContext.height
                    }, direction = module.get.direction(scroll.top), elementScroll = fits ? 0 : module.get.elementScroll(scroll.top), // shorthand
                    doesntFit = !fits, elementVisible = element.height !== 0;
...
(function($, window1, document1, undefined) {
    ...
    $.fn.tab = function(parameters) {
        ...
        $allModules = $.isFunction(this) ? $(window1) : $(this), moduleSelector = $allModules.selector || '', time = new Date().getTime(), performance = [], query = arguments[0], methodInvoked = typeof query == 'string', queryArguments = [].slice.call(arguments, 1), initializedHistory = false, returnedValue;
        $allModules.each(function() {
            ...
            module = {
                ...
                changeTab: function(tabPath) {
                    var pushStateAvailable = window1.history && window1.history.pushState, shouldIgnoreLoad = pushStateAvailable && settings.ignoreFirstLoad && firstLoad, remoteContent = settings.auto || $.isPlainObject(settings.apiSettings), // only add default path if not remote content
                ...
                scrollTo: function($element) {
                    ...
                    if (scrollOffset !== false) {
                        ...
                        $(document1).scrollTop(scrollOffset);
                    }
                },
                update: {
                ...
                utilities: {
                    ...
                    pathToArray: function(pathName) {
                        ...
                        return typeof pathName == 'string' ? pathName.split('/') : [
                            pathName
                        ];
                    },
    ...
    $.tab = function() {
        $(window1).tab.apply(this, arguments);
    };
    $.fn.tab.settings = {
        name: 'Tab',
        namespace: 'tab',
...
(function($, window1, document1, undefined) {
    ...
    $.fn.transition = function() {
        var $allModules = $(this), moduleSelector = $allModules.selector || '', time = new Date().getTime(), performance = [], moduleArguments = arguments, query = moduleArguments[0], queryArguments = [].slice.call(arguments, 1), methodInvoked = typeof query === 'string', requestAnimationFrame = window1.requestAnimationFrame || window1.mozRequestAnimationFrame || window1.webkitRequestAnimationFrame || window1.msRequestAnimationFrame || function(callback) {
            setTimeout(callback, 0);
        }, returnedValue;
        $allModules.each(function(index) {
            var $module = $(this), element = this, // set at run time
            settings, instance, error, className, metadata, animationEnd, animationName, namespace, moduleNamespace, eventNamespace, module;
            module = {
                initialize: function() {
                    // get full settings
                ...
                force: {
                    visible: function() {
                        var style = $module.attr('style'), userStyle = module.get.userStyle(), displayType = module.get.displayType(), overrideStyle = userStyle + 'display: ' + displayType + ' !important;', currentDisplay = $module.css('display'), emptyStyle = style === undefined || style === '';
                    ...
                    hidden: function() {
                        var style = $module.attr('style'), currentDisplay = $module.css('display'), emptyStyle = style === undefined || style === '';
                ...
                get: {
                    ...
                    animationStartEvent: function() {
                        var element = document1.createElement('div'), animations = {
...
(function($, window1, document1, undefined) {
    'use strict';
    var window1 = typeof window1 != 'undefined' && window1.Math == Math ? window1 : typeof self != 'undefined' && self.Math == Math ? self : Function('return this')();
    $.api = $.fn.api = function(parameters) {
        var // use window context if none specified
        $allModules = $.isFunction(this) ? $(window1) : $(this), moduleSelector = $allModules.selector || '', time = new Date().getTime(), performance = [], query = arguments[0], methodInvoked = typeof query == 'string', queryArguments = [].slice.call(arguments, 1), returnedValue;
        $allModules.each(function() {
            var settings = $.isPlainObject(parameters) ? $.extend(true, {}, $.fn.api.settings, parameters) : $.extend({}, $.fn.api.settings), // internal aliases
            ...
            element = this, context = $context[0], instance = $module.data(moduleNamespace), module;
            module = {
                initialize: function() {
                    if (!methodInvoked) {
                        module.bind.events();
                ...
                event: {
                    ...
                    xhr: {
                        ...
                        // nothing special
                            ...
                            var context = this, elapsedTime = new Date().getTime() - requestStartTime, timeLeft = settings.loadingDuration - elapsedTime, translatedResponse = $.isFunction(settings.onResponse) ? module.is.expectingJSON() ? settings.onResponse.call(context, $.extend(true, {}, response)) : settings.onResponse.call(context, response) : false;
                        ...
                        fail: function(xhr, status, httpMessage) {
                            var context = this, elapsedTime = new Date().getTime() - requestStartTime, timeLeft = settings.loadingDuration - elapsedTime;
                            timeLeft = timeLeft > 0 ? timeLeft : 0;
                            if (timeLeft > 0) {
                                module.debug('Response completed early delaying state change by', timeLeft);
                            }
                    ...
                    request: {
                        ...
                        fail: function(xhr, status, httpMessage) {
                            ...
                            response = module.get.responseFromXHR(xhr), errorMessage = module.get.errorFromRequest(response, status, httpMessage);
                            if (status == 'aborted') {
                ...
                create: {
                    ...
                    mockedXHR: function() {
                        ...
                        textStatus = false, status = false, httpMessage = false, responder = settings.mockResponse || settings.response, asyncResponder = settings.mockResponseAsync || settings.responseAsync, asyncCallback, response, mockedXHR;
                ...
                get: {
                    ...
                    urlEncodedValue: function(value) {
                        var decodedValue = window1.decodeURIComponent(value), encodedValue = window1.encodeURIComponent(value), alreadyEncoded = decodedValue !== value;
                        if (alreadyEncoded) {
...
(function($, window1, document1, undefined) {
    ...
    $.fn.visibility = function(parameters) {
        var $allModules = $(this), moduleSelector = $allModules.selector || '', time = new Date().getTime(), performance = [], query = arguments[0], methodInvoked = typeof query == 'string', queryArguments = [].slice.call(arguments, 1), returnedValue, moduleCount = $allModules.length, loadedCount = 0;
        $allModules.each(function() {
            var settings = $.isPlainObject(parameters) ? $.extend(true, {}, $.fn.visibility.settings, parameters) : $.extend({}, $.fn.visibility.settings), className = settings.className, namespace = settings.namespace, error = settings.error, metadata = settings.metadata, eventNamespace = '.' + namespace, moduleNamespace = 'module-' + namespace, $window = $(window1), $module = $(this), $context = $(settings.context), $placeholder, selector = $module.selector || '', instance = $module.data(moduleNamespace), requestAnimationFrame = window1.requestAnimationFrame || window1.mozRequestAnimationFrame || window1.webkitRequestAnimationFrame || window1.msRequestAnimationFrame || function(callback) {
                setTimeout(callback, 0);
            }, element = this, disabled = false, contextObserver, observer, module;
            module = {
                initialize: function() {
                ...
                observeChanges: function() {
                    if ('MutationObserver' in window1) {
                        ...
                        observer = new MutationObserver(module.event.changed);
                        contextObserver.observe(document1, {
                            childList: true,
                            subtree: true
                        });
                        observer.observe(element, {
                ...
                precache: function(images, callback) {
                    ...
                    var imagesLength = images.length, loadedCounter = 0, cache = [], cacheImage = document1.createElement('img'), handleLoad = function() {
                        loadedCounter++;
                    ...
                    while(imagesLength--){
                        cacheImage = document1.createElement('img');
                ...
                passed: function(amount, newCallback) {
                    var calculations = module.get.elementCalculations(), amountInPixels;
                    // assign callback
                ...
                save: {
                    ...
                    elementPosition: function() {
                        var element = module.cache.element, screen = module.get.screenSize();
                    ...
                    elementCalculations: function() {
                        var screen = module.get.screenCalculations(), element = module.get.elementPosition();
                        // offset
