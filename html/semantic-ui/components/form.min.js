!function(T, e, D, O) {
    ...
    e = void 0 !== e && e.Math == Math ? e : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), T.fn.form = function(x) {
        var k, E = T(this), w = E.selector || "", C = (new Date).getTime(), V = [], R = x, F = arguments[1], S = "string" == typeof R, A = [].slice.call(arguments, 1);
        return E.each(function() {
            var n, s, t, e, d, u, c, f, p, r, l, i, a, m, g, h, o = T(this), v = this, b = [], y = !1;
            (h = {
                initialize: function() {
                ...
                bindEvents: function() {
                    h.verbose("Attaching form events"), o.on("submit" + m, h.validate.form).on("blur" + m, f.field, h.event.field.blur).on("click" + m, f.submit, h.submit).on("click" + m, f.reset, h.reset).on("click" + m, f.clear, h.clear), d.keyboardShortcuts && o.on("keydown" + m, f.field, h.event.field.keydown), n.each(function() {
                        var e = T(this), t = e.prop("type"), n = h.get.changeEvent(t, e);
                        T(this).on(n + m, h.event.field.change);
                    });
                },
                clear: function() {
                    n.each(function() {
                        var e = T(this), t = e.parent(), n = e.closest(s), r = n.find(f.prompt), i = e.data(c.defaultValue) || "", a = t.is(f.uiCheckbox), o = t.is(f.uiDropdown);
                        n.hasClass(p.error) && (h.verbose("Resetting error on field", n), n.removeClass(p.error), r.remove()), o ? (h.verbose("Resetting dropdown value", t, i), t.dropdown("clear")) : a ? e.prop("checked", !1) : (h.verbose("Resetting field value", e, i), e.val(""));
                    });
                },
                reset: function() {
                    n.each(function() {
                        var e = T(this), t = e.parent(), n = e.closest(s), r = n.find(f.prompt), i = e.data(c.defaultValue), a = t.is(f.uiCheckbox), o = t.is(f.uiDropdown), l = n.hasClass(p.error);
                        i !== O && (l && (h.verbose("Resetting error on field", n), n.removeClass(p.error), r.remove()), o ? (h.verbose("Resetting dropdown value", t, i), t.dropdown("restore defaults")) : a ? (h.verbose("Resetting checkbox value", t, i), e.prop("checked", i)) : (h.verbose("Resetting field value", e, i), e.val(i)));
                    });
                },
                determine: {
                    isValid: function() {
                        var n = !0;
                        return T.each(u, function(e, t) {
                ...
                is: {
                    ...
                    valid: function(e) {
                        var n = !0;
                        return e ? (h.verbose("Checking if field is valid", e), h.validate.field(u[e], e, !1)) : (h.verbose("Checking if form is valid"), T.each(u, function(e, t) {
                            h.is.valid(e) || (n = !1);
                        }), n);
                    }
                },
                ...
                event: {
                    field: {
                        keydown: function(e) {
                            var t = T(this), n = e.which, r = t.is(f.input), i = t.is(f.checkbox), a = 0 < t.closest(f.uiDropdown).length, o = 13;
                            n == 27 && (h.verbose("Escape key pressed blurring field"), t.blur()), e.ctrlKey || n != o || !r || a || i || (y || (t.one("keyup" + m, h.event.field.keyup), h.submit(), h.debug("Enter pressed on input submitting form")), y = !0);
                        },
                        keyup: function() {
                            y = !1;
                        },
                        blur: function(e) {
                            var t = T(this), n = t.closest(s), r = h.get.validation(t);
                            n.hasClass(p.error) ? (h.debug("Revalidating field", t, r), r && h.validate.field(r)) : "blur" == d.on && r && h.validate.field(r);
                        },
                        change: function(e) {
                            var t = T(this), n = t.closest(s), r = h.get.validation(t);
                            r && ("change" == d.on || n.hasClass(p.error) && d.revalidate) && (clearTimeout(h.timer), h.timer = setTimeout(function() {
                ...
                get: {
                    ...
                    prompt: function(e, t) {
                        var n, r, i = h.get.ruleName(e), a = h.get.ancillaryValue(e), o = h.get.field(t.identifier), l = o.val(), s = T.isFunction(e.prompt) ? e.prompt(l) : e.prompt || d.prompt[i] || d.text.unspecifiedRule, u = -1 !== s.search("{value}"), c = -1 !== s.search("{name}");
                        return u && (s = s.replace("{value}", o.val())), c && (r = 1 == (n = o.closest(f.group).find("label").eq(0)).length ? n.text() : o.prop("placeholder") || d.text.unspecifiedField, s = s.replace("{name}", r)), s = (s = s.replace("{identifier}", t.identifier)).replace("{ruleValue}", a), e.prompt || h.verbose("Using default validation prompt for type", s, i), s;
                    },
                    settings: function() {
                        if (T.isPlainObject(x)) {
                            var e = Object.keys(x);
                            0 < e.length && x[e[0]].identifier !== O && x[e[0]].rules !== O ? (d = T.extend(!0, {}, T.fn.form.settings, F), u = T.extend({}, T.fn.form.settings.defaults, x), h.error(d.error.oldSyntax, v), h.verbose("Extending settings from legacy parameters", u, d)) : (x.fields && h.is.shorthandFields(x.fields) && (x.fields = h.get.fieldsFromShorthand(x.fields)), d = T.extend(!0, {}, T.fn.form.settings, x), u = T.extend({}, T.fn.form.settings.defaults, d.fields), h.verbose("Extending settings", u, d));
                        } else d = T.fn.form.settings, u = T.fn.form.settings.defaults, h.verbose("Using default form validation", u, d);
                        i = d.namespace, c = d.metadata, f = d.selector, p = d.className, r = d.regExp, l = d.error, a = "module-" + i, m = "." + i, g = o.data(a), h.refresh();
                    },
                    field: function(e) {
                    ...
                    validation: function(n) {
                        var r, i;
                        return !!u && (T.each(u, function(e, t) {
                    ...
                    values: function(e) {
                        var t = T.isArray(e) ? h.get.fields(e) : n, u = {};
                        return t.each(function(e, t) {
                            var n = T(t), r = (n.prop("type"), n.prop("name")), i = n.val(), a = n.is(f.checkbox), o = n.is(f.radio), l = -1 !== r.indexOf("[]"), s = !!a && n.is(":checked");
                            r && (l ? (r = r.replace("[]", ""), u[r] || (u[r] = []), a ? s ? u[r].push(i || !0) : u[r].push(!1) : u[r].push(i)) : o ? u[r] !== O && 0 != u[r] || (u[r] = !!s && (i || !0)) : u[r] = a ? !!s && (i || !0) : i);
                        }), u;
                    }
                },
                has: {
                ...
                add: {
                    ...
                    field: function(n, e) {
                        var r = {};
                        h.is.shorthandRules(e) ? (e = T.isArray(e) ? e : [
                            e
                        ], r[n] = {
                            rules: []
                        }, T.each(e, function(e, t) {
                    ...
                    fields: function(e) {
                        var t;
                        t = e && h.is.shorthandFields(e) ? h.get.fieldsFromShorthand(e) : e, u = T.extend({}, u, t);
                    },
                    prompt: function(e, t) {
                        var n = h.get.field(e).closest(s), r = n.children(f.prompt), i = 0 !== r.length;
                        t = "string" == typeof t ? [
                            t
                ...
                remove: {
                    rule: function(n, e) {
                        ...
                        if (e == O) return h.debug("Removed all rules"), void (u[n].rules = []);
                        u[n] != O && T.isArray(u[n].rules) && T.each(u[n].rules, function(e, t) {
                    ...
                    prompt: function(e) {
                        var t = h.get.field(e).closest(s), n = t.children(f.prompt);
                        t.removeClass(p.error), d.inline && n.is(":visible") && (h.verbose("Removing prompt for field", e), d.transition && T.fn.transition !== O && o.transition("is supported") ? n.transition(d.transition + " out", d.duration, function() {
                            n.remove();
                ...
                set: {
                    ...
                    defaults: function() {
                        n.each(function() {
                            var e = T(this), t = 0 < e.filter(f.checkbox).length ? e.is(":checked") : e.val();
                    ...
                    values: function(e) {
                        T.isEmptyObject(e) || T.each(e, function(e, t) {
                            var n, r = h.get.field(e), i = r.parent(), a = T.isArray(t), o = i.is(f.uiCheckbox), l = i.is(f.uiDropdown), s = r.is(f.radio) && o;
                            0 < r.length && (a && o ? (h.verbose("Selecting multiple", t, r), i.checkbox("uncheck"), T.each(t, function(e, t) {
                ...
                validate: {
                    ...
                    field: function(n, e, t) {
                        t = t === O || t, "string" == typeof n && (h.verbose("Validating field", n), n = u[e = n]);
                        var r = n.identifier || e, i = h.get.field(r), a = !!n.depends && h.get.field(n.depends), o = !0, l = [];
                        return n.identifier || (h.debug("Using field name as identifier", r), n.identifier = r), i.prop("disabled") ? (h.debug("Field is disabled. Skipping", r), o = !0) : n.optional && h.is.blank(i) ? (h.debug("Field is optional and blank. Skipping", r), o = !0) : n.depends && h.is.empty(a) ? (h.debug("Field depends on another value that is not present or empty. Skipping", a), o = !0) : n.rules !== O && T.each(n.rules, function(e, t) {
                    ...
                    rule: function(e, t) {
                        var n = h.get.field(e.identifier), r = (t.type, n.val()), i = h.get.ancillaryValue(t), a = h.get.ruleName(t), o = d.rules[a];
                ...
                performance: {
                    log: function(e) {
                        var t, n;
                        d.performance && (n = (t = (new Date).getTime()) - (C || t), C = t, V.push({
                            Name: e[0],
                    ...
                    display: function() {
                        var e = d.name + ":", n = 0;
                        C = !1, clearTimeout(h.performance.timer), T.each(V, function(e, t) {
                            n += t["Execution Time"];
                ...
                invoke: function(r, e, t) {
                    var i, a, n, o = g;
                    return e = e || A, t = v || t, "string" == typeof r && o !== O && (r = r.split(/[\. ]/), i = r.length - 1, T.each(r, function(e, t) {
                    ...
                    })), T.isFunction(a) ? n = a.apply(t, e) : a !== O && (n = a), T.isArray(k) ? k.push(n) : k !== O ? k = [
                        k,
                        n
                    ] : n !== O && (k = n), a;
                }
        ...
        rules: {
            ...
            regExp: function(e, t) {
                ...
                var n, r = t.match(T.fn.form.settings.regExp.flags);
                return r && (t = 2 <= r.length ? r[1] : t, n = 3 <= r.length ? r[2] : ""), e.match(new RegExp(t, n));
            },
            integer: function(e, t) {
                var n, r, i, a = T.fn.form.settings.regExp.integer;
                return t && -1 === [
                    "",
                    ".."
                ].indexOf(t) && (-1 == t.indexOf("..") ? a.test(t) && (n = r = t - 0) : (i = t.split("..", 2), a.test(i[0]) && (n = i[0] - 0), a.test(i[1]) && (r = i[1] - 0))), a.test(e) && (n === O || n <= e) && (r === O || e <= r);
            },
            decimal: function(e) {
            ...
            match: function(e, t) {
                var n;
                T(this);
                return 0 < T('[data-validate="' + t + '"]').length ? n = T('[data-validate="' + t + '"]').val() : 0 < T("#" + t).length ? n = T("#" + t).val() : 0 < T('[name="' + t + '"]').length ? n = T('[name="' + t + '"]').val() : 0 < T('[name="' + t + '[]"]').length && (n = T('[name="' + t + '[]"]')), n !== O && e.toString() == n.toString();
            },
            ...
            creditCard: function(n, e) {
                ...
                }, a = {}, o = !1, l = "string" == typeof e && e.split(",");
                if ("string" == typeof n && 0 !== n.length) {
                    if (n = n.replace(/[\-]/g, ""), l && (T.each(l, function(e, t) {
                        (r = i[t]) && (a = {
                            length: -1 !== T.inArray(n.length, r.length),
                            pattern: -1 !== n.search(r.pattern)
                        }).length && a.pattern && (o = !0);
                    }), !o)) return !1;
                    if ((t = {
                        number: -1 !== T.inArray(n.length, i.unionPay.length),
                        pattern: -1 !== n.search(i.unionPay.pattern)
                    }).number && t.pattern) return !0;
                    for(var s = n.length, u = 0, c = [
                        [
                            0,
                            1,
                            2,
                    ...
                    ], d = 0; s--;)d += c[u][parseInt(n.charAt(s), 10)], u ^= 1;
                    return d % 10 == 0 && 0 < d;
                }
            },
