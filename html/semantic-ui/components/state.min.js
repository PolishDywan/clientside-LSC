!function(e, t, n, a) {
    ...
    t = void 0 !== t && t.Math == Math ? t : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), e.fn.state = function(t) {
        var i, o = e(this), s = o.selector || "", c = (n.documentElement, (new Date).getTime()), r = [], l = arguments[0], u = "string" == typeof l, d = [].slice.call(arguments, 1);
        return o.each(function() {
            var n, f = e.isPlainObject(t) ? e.extend(!0, {}, e.fn.state.settings, t) : e.extend({}, e.fn.state.settings), v = f.error, g = f.metadata, b = f.className, x = f.namespace, h = f.states, m = f.text, p = "." + x, T = x + "-module", y = e(this), w = this, C = y.data(T);
            n = {
                initialize: function() {
                    n.verbose("Initializing module"), f.automatic && n.add.defaults(), f.context && "" !== s ? e(f.context).on(s, "mouseenter" + p, n.change.text).on(s, "mouseleave" + p, n.reset.text).on(s, "click" + p, n.toggle.state) : y.on("mouseenter" + p, n.change.text).on("mouseleave" + p, n.reset.text).on("click" + p, n.toggle.state), n.instantiate();
                },
                instantiate: function() {
                    n.verbose("Storing instance of module", n), C = n, y.data(T, n);
                },
                destroy: function() {
                    n.verbose("Destroying previous module", C), y.off(p).removeData(T);
                },
                refresh: function() {
                    ...
                    state: function() {
                        ...
                        if (n.allows("active") && n.is.enabled()) {
                            if (n.refresh(), e.fn.api !== a) {
                                if (t = y.api("get request"), y.api("was cancelled")) n.debug("API Request cancelled by beforesend"), f.activateTest = function() {
                                    return !1;
                ...
                listenTo: function(t) {
                    n.debug("API request detected, waiting for state signal", t), t && (m.loading && n.update.text(m.loading), e.when(t).then(function() {
                ...
                activate: function() {
                    f.activateTest.call(w) && (n.debug("Setting state to active"), y.addClass(b.active), n.update.text(m.active), f.onActivate.call(w));
                },
                deactivate: function() {
                    f.deactivateTest.call(w) && (n.debug("Setting state to inactive"), y.removeClass(b.active), n.update.text(m.inactive), f.onDeactivate.call(w));
                },
                sync: function() {
                ...
                flash: {
                    text: function(e, t, a) {
                        var i = n.get.text();
                        n.debug("Flashing text message", e, t), e = e || f.text.flash, t = t || f.flashDuration, a = a || function() {}, n.update.text(e), setTimeout(function() {
                ...
                reset: {
                    text: function() {
                        var e = m.active || y.data(g.storedText), t = m.inactive || y.data(g.storedText);
                ...
                update: {
                    text: function(e) {
                        var t = n.get.text();
                        e && e !== t ? (n.debug("Updating text", e), f.selector.text ? y.data(g.storedText, e).find(f.selector.text).text(e) : y.data(g.storedText, e).html(e)) : n.debug("Text is already set, ignoring update", e);
                    }
                },
                setting: function(t, i) {
                    if (n.debug("Changing setting", t, i), e.isPlainObject(t)) e.extend(!0, f, t);
                    else {
                        if (i === a) return f[t];
                ...
                performance: {
                    log: function(e) {
                        var t, a;
                        f.performance && (a = (t = (new Date).getTime()) - (c || t), c = t, r.push({
                            Name: e[0],
                    ...
                    display: function() {
                        var t = f.name + ":", i = 0;
                        c = !1, clearTimeout(n.performance.timer), e.each(r, function(e, t) {
                            i += t["Execution Time"];
                        }), t += " " + i + "ms", s && (t += " '" + s + "'"), (console.group !== a || console.table !== a) && r.length > 0 && (console.groupCollapsed(t), console.table ? console.table(r) : e.each(r, function(e, t) {
                ...
                invoke: function(t, o, s) {
                    var c, r, l, u = C;
                    return o = o || d, s = w || s, "string" == typeof t && u !== a && (t = t.split(/[\. ]/), c = t.length - 1, e.each(t, function(i, o) {
                        var s = i != c ? o + t[i + 1].charAt(0).toUpperCase() + t[i + 1].slice(1) : t;
                        if (e.isPlainObject(u[s]) && i != c) u = u[s];
                        else {
                            if (u[s] !== a) return r = u[s], !1;
                            if (!e.isPlainObject(u[o]) || i == c) return u[o] !== a ? (r = u[o], !1) : (n.error(v.method, t), !1);
                            u = u[o];
                        }
                    })), e.isFunction(r) ? l = r.apply(s, o) : r !== a && (l = r), e.isArray(i) ? i.push(l) : i !== a ? i = [
                        i,
                        l
                    ] : l !== a && (i = l), r;
                }
