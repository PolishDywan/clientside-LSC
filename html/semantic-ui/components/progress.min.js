!function(E, e, P, T) {
    ...
    E.fn.progress = function(m) {
        var b, e = E(this), h = e.selector || "", x = (new Date).getTime(), w = [], y = m, V = "string" == typeof y, C = [].slice.call(arguments, 1);
        return e.each(function() {
            var s, r = E.isPlainObject(m) ? E.extend(!0, {}, E.fn.progress.settings, m) : E.extend({}, E.fn.progress.settings), t = r.className, n = r.metadata, e = r.namespace, a = r.selector, l = r.error, o = "." + e, i = "module-" + e, c = E(this), u = E(this).find(a.bar), d = E(this).find(a.progress), g = E(this).find(a.label), v = this, p = c.data(i), f = !1;
            s = {
                initialize: function() {
                ...
                get: {
                    text: function(e) {
                        var t = s.value || 0, n = s.total || 0, r = f ? s.get.displayPercent() : s.percent || 0, a = 0 < s.total ? n - t : 100 - r;
                    ...
                    transitionEnd: function() {
                        var e, t = P.createElement("element"), n = {
                ...
                invoke: function(r, e, t) {
                    ...
                    })), E.isFunction(o) ? n = o.apply(t, e) : o !== T && (n = o), E.isArray(b) ? b.push(n) : b !== T ? b = [
                        b,
                        n
                    ] : n !== T && (b = n), o;
                }
