!function(X, Y, G, J) {
    ...
    Y = void 0 !== Y && Y.Math == Math ? Y : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), X.fn.dropdown = function(z) {
        var P, H = X(this), j = X(G), N = H.selector || "", U = "ontouchstart" in G.documentElement, K = (new Date).getTime(), W = [], B = z, $ = "string" == typeof B, Q = [].slice.call(arguments, 1);
        return H.each(function(n) {
            var e, t, i, a, o, s, r, m, h = X.isPlainObject(z) ? X.extend(!0, {}, X.fn.dropdown.settings, z) : X.extend({}, X.fn.dropdown.settings), g = h.className, c = h.message, l = h.fields, p = h.keys, b = h.metadata, u = h.namespace, d = h.regExp, w = h.selector, v = h.error, f = h.templates, x = "." + u, C = "module-" + u, S = X(this), y = X(h.context), A = S.find(w.text), T = S.find(w.search), k = S.find(w.sizer), L = S.find(w.input), I = S.find(w.icon), D = 0 < S.prev().find(w.text).length ? S.prev().find(w.text) : S.prev(), q = S.children(w.menu), R = q.find(w.item), O = !1, V = !1, E = !1, M = this, F = S.data(C);
            m = {
                initialize: function() {
                ...
                create: {
                    ...
                    userChoice: function(e) {
                        var n, i, a;
                        return !!(e = e || m.get.userValues()) && (e = X.isArray(e) ? e : [
                            e
                ...
                select: {
                    ...
                    nextAvailable: function(e) {
                        var t = (e = e.eq(0)).nextAll(w.item).not(w.unselectable).eq(0), n = e.prevAll(w.item).not(w.unselectable).eq(0);
                ...
                setup: {
                    ...
                    returnedObject: function() {
                        var e = H.slice(0, n), t = H.slice(n + 1);
                        H = e.add(S).add(t);
                    }
                },
                refresh: function() {
                ...
                filter: function(e) {
                    var t = e !== J ? e : m.get.query(), n = function() {
                ...
                filterItems: function(e) {
                    var i = e !== J ? e : m.get.query(), a = null, t = m.escape.string(i), o = new RegExp("^" + t, "igm");
                ...
                forceSelection: function() {
                    var e = R.not(g.filtered).filter("." + g.selected).eq(0), t = R.not(g.filtered).filter("." + g.active).eq(0), n = 0 < e.length ? e : t;
                ...
                event: {
                    ...
                    label: {
                        click: function(e) {
                            var t = X(this), n = S.find(w.label), i = n.filter("." + g.active), a = t.nextAll("." + g.active), o = t.prevAll("." + g.active), s = 0 < a.length ? t.nextUntil(a).add(i).add(t) : t.prevUntil(o).add(i).add(t);
                    ...
                    menu: {
                        mutation: function(e) {
                            var t = e[0], n = t.addedNodes ? X(t.addedNodes[0]) : X(!1), i = t.removedNodes ? X(t.removedNodes[0]) : X(!1), a = n.add(i), o = a.is(w.addition) || 0 < a.closest(w.addition).length, s = a.is(w.message) || 0 < a.closest(w.message).length;
                    ...
                    item: {
                        mouseenter: function(e) {
                            var t = X(e.target), n = X(this), i = n.children(w.menu), a = n.siblings(w.item).children(w.menu), o = 0 < i.length;
                        ...
                        click: function(e, t) {
                            var n = X(this), i = X(e ? e.target : ""), a = n.find(w.menu), o = m.get.choiceText(n), s = m.get.choiceValue(n, o), r = 0 < a.length, l = 0 < a.find(i).length;
                    ...
                    document: {
                        keydown: function(e) {
                            ...
                            if (m.is.inObject(t, p)) {
                                var n = S.find(w.label), i = n.filter("." + g.active), a = (i.data(b.value), n.index(i)), o = n.length, s = 0 < i.length, r = 1 < i.length, l = 0 === a, c = a + 1 == o, u = m.is.searchSelection(), d = m.is.focusedOnSearch(), v = m.is.focused(), f = d && 0 === m.get.caretPosition();
                                if (u && !s && !d) return;
                ...
                trigger: {
                    change: function() {
                        var e = G.createEvent("HTMLEvents"), t = L[0];
                ...
                determine: {
                    ...
                    eventInModule: function(e, t) {
                        var n = X(e.target), i = 0 < n.closest(G.documentElement).length, a = 0 < n.closest(S).length;
                    ...
                    eventOnElement: function(e, t) {
                        var n = X(e.target), i = n.closest(w.siblingLabel), a = G.body.contains(e.target), o = 0 === S.find(i).length, s = 0 === n.closest(q).length;
                ...
                get: {
                    ...
                    value: function() {
                        var e = 0 < L.length ? L.val() : S.data(b.value), t = X.isArray(e) && 1 === e.length && "" === e[0];
                        return e === J || t ? "" : e;
                    },
                    values: function() {
                        var e = m.get.value();
                    ...
                    selectValues: function() {
                        ...
                        return S.find("option").each(function() {
                            var e = X(this), t = e.html(), n = e.attr("disabled"), i = e.attr("value") !== J ? e.attr("value") : t;
                    ...
                    itemWithAdditions: function(e) {
                        var t = m.get.item(e), n = m.create.userChoice(e);
                    ...
                    item: function(i, a) {
                        ...
                        return i = i !== J ? i : m.get.values() !== J ? m.get.values() : m.get.text(), e = o ? 0 < i.length : i !== J && null !== i, o = m.is.multiple() && X.isArray(i), a = "" === i || 0 === i || a || !1, e && R.each(function() {
                            var e = X(this), t = m.get.choiceText(e), n = m.get.choiceValue(e, t);
                            if (null !== n && n !== J) {
                ...
                scrollPage: function(e, t) {
                    var n, i, a = t || m.get.selectedItem(), o = a.closest(w.menu), s = o.outerHeight(), r = o.scrollTop(), l = R.eq(0).outerHeight(), c = Math.floor(s / l), u = (o.prop("scrollHeight"), "up" == e ? r - l * c : r + l * c), d = R.not(w.unselectable);
                ...
                set: {
                    filtered: function() {
                        var e = m.is.multiple(), t = m.is.searchSelection(), n = e && t, i = t ? m.get.query() : "", a = "string" == typeof i && 0 < i.length, o = m.get.searchWidth(), s = "" !== i;
                    ...
                    selectedItem: function(e) {
                        var t = m.get.choiceValue(e), n = m.get.choiceText(e, !1), i = m.get.choiceText(e, !0);
                    ...
                    selectedLetter: function(e) {
                        var t, n = R.filter("." + g.selected), i = 0 < n.length && m.has.firstLetter(n, e), a = !1;
                    ...
                    value: function(e, t, n) {
                        var i = m.escape.value(e), a = 0 < L.length, o = m.get.values(), s = e !== J ? String(e) : e;
                        if (a) {
                    ...
                    selected: function(e, r) {
                        ...
                        (r = h.allowAdditions ? r || m.get.itemWithAdditions(e) : r || m.get.item(e)) && (m.debug("Setting selected menu item to", r), m.is.multiple() && m.remove.searchWidth(), m.is.single() ? (m.remove.activeItem(), m.remove.selectedItem()) : h.useLabels && m.remove.selectedItem(), r.each(function() {
                            var e = X(this), t = m.get.choiceText(e), n = m.get.choiceValue(e, t), i = e.hasClass(g.filtered), a = e.hasClass(g.active), o = e.hasClass(g.addition), s = l && 1 == r.length;
                ...
                add: {
                    label: function(e, t, n) {
                        var i, a = m.is.searchSelection() ? T : A, o = m.escape.value(e);
                    ...
                    message: function(e) {
                        var t = q.children(w.message), n = h.templates.message(m.add.variables(e));
                    ...
                    userSuggestion: function(e) {
                        var t, n = q.children(w.addition), i = m.get.item(e), a = i && i.not(w.addition).length, o = 0 < n.length;
                    ...
                    value: function(e, t, n) {
                        ...
                        m.has.value(e) ? m.debug("Value already selected") : "" !== e ? (i = X.isArray(a) ? (i = a.concat([
                            e
                        ]), m.get.uniqueArray(i)) : [
                            e
                ...
                remove: {
                    ...
                    optionValue: function(e) {
                        var t = m.escape.value(e), n = L.find('option[value="' + m.escape.string(t) + '"]');
                    ...
                    labels: function(e) {
                        e = e || S.find(w.label), m.verbose("Removing labels", e), e.each(function() {
                            var e = X(this), t = e.data(b.value), n = t !== J ? String(t) : t, i = m.is.userValue(n);
                ...
                has: {
                    ...
                    label: function(e) {
                        var t = m.escape.value(e), n = S.find(w.label);
                ...
                animate: {
                    show: function(e, t) {
                        var n, i = t || q, a = t ? function() {} : function() {
                    ...
                    hide: function(e, t) {
                        var n = t || q, i = (t ? h.duration : h.duration, t ? function() {} : function() {
                ...
                escape: {
                    value: function(e) {
                        var t = X.isArray(e), n = "string" == typeof e, i = !n && !t, a = n && -1 !== e.search(d.quote), o = [];
                ...
                invoke: function(i, e, t) {
                    ...
                    })), X.isFunction(o) ? n = o.apply(t, e) : o !== J && (n = o), X.isArray(P) ? P.push(n) : P !== J ? P = [
                        P,
                        n
                    ] : n !== J && (P = n), o;
                }
        ...
        menu: function(e, a) {
            ...
            return X.each(t, function(e, t) {
                var n = t[a.text] ? 'data-text="' + t[a.text] + '"' : "", i = t[a.disabled] ? "disabled " : "";
