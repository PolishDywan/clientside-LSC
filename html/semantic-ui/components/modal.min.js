!function(j, q, L, N) {
    ...
    q = void 0 !== q && q.Math == Math ? q : "undefined" != typeof self && self.Math == Math ? self : Function("return this")(), j.fn.modal = function(w) {
        var C, e = j(this), F = j(q), M = j(L), x = j("body"), H = e.selector || "", A = (new Date).getTime(), O = [], D = w, T = "string" == typeof D, z = [].slice.call(arguments, 1), E = q.requestAnimationFrame || q.mozRequestAnimationFrame || q.webkitRequestAnimationFrame || q.msRequestAnimationFrame || function(e) {
            setTimeout(e, 0);
        };
        return e.each(function() {
            var i, t, e, o, a, n, r, s, c, l = j.isPlainObject(w) ? j.extend(!0, {}, j.fn.modal.settings, w) : j.extend({}, j.fn.modal.settings), d = l.selector, u = l.className, m = l.namespace, f = l.error, g = "." + m, h = "module-" + m, v = j(this), b = j(l.context), p = v.find(d.close), y = this, k = v.data(h), S = !1;
            c = {
                initialize: function() {
                ...
                event: {
                    ...
                    click: function(e) {
                        if (l.closable) {
                            var n = 0 < j(e.target).closest(d.modal).length, i = j.contains(L.documentElement, e.target);
                ...
                cacheSizes: function() {
                    ...
                    var e = v.prop("scrollHeight"), n = v.outerWidth(), i = v.outerHeight();
                ...
                can: {
                    ...
                    fit: function() {
                        var e = c.cache.contextHeight, n = c.cache.contextHeight / 2, i = c.cache.topOffset, t = c.cache.scrollHeight, o = c.cache.height, a = l.padding;
                ...
                set: {
                    autofocus: function() {
                        var e = v.find("[tabindex], :input").filter(":visible"), n = e.filter("[autofocus]"), i = 0 < n.length ? n.first() : e.first();
                        0 < i.length && i.focus();
                    },
                    clickaway: function() {
                    ...
                    modalOffset: function() {
                        var e = c.cache.width, n = c.cache.height;
                        v.css({
                ...
                invoke: function(t, e, n) {
                    ...
                    })), j.isFunction(a) ? i = a.apply(n, e) : a !== N && (i = a), j.isArray(C) ? C.push(i) : C !== N ? C = [
                        C,
                        i
                    ] : i !== N && (C = i), a;
                }
