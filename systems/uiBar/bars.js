...
class BaseBar {
    ...
    drawBackground(y) {
        ...
        if (this._highlightColor) native.drawSprite("timerbars", "all_white_bg", Helpers.coordsAndSize.bgBaseX, y, Helpers.coordsAndSize.timerBarWidth, this._thin ? Helpers.coordsAndSize.timerBarThinHeight : Helpers.coordsAndSize.timerBarHeight, 0.0, this._highlightColor[0], this._highlightColor[1], this._highlightColor[2], this._highlightColor[3], false);
        native.drawSprite("timerbars", "all_black_bg", Helpers.coordsAndSize.bgBaseX, y, Helpers.coordsAndSize.timerBarWidth, this._thin ? Helpers.coordsAndSize.timerBarThinHeight : Helpers.coordsAndSize.timerBarHeight, 0.0, 255, 255, 255, 140, false);
    }
    drawTitle(y) {
        Helpers.drawText(this._title, [
            Helpers.coordsAndSize.initialX,
            y - 0.004
        ], this._titleDrawParams.font, this._titleDrawParams.scale, this._titleDrawParams.color, this._titleDrawParams.justification, this._titleDrawParams.wrap);
    }
    draw(y) {
...
export class TextBar extends BaseBar {
    ...
    draw(y) {
        ...
        Helpers.drawText(this._text, [
            Helpers.coordsAndSize.initialX,
            y
        ], this._textDrawParams.font, this._textDrawParams.scale, this._textDrawParams.color, this._textDrawParams.justification, this._textDrawParams.wrap);
    }
...
export class CheckpointBar extends BaseBar {
    ...
    draw(y) {
        ...
        for(let i = 0, cpX = Helpers.coordsAndSize.checkpointBaseX; i < this._numCheckpoints; i++){
            ...
            native.drawSprite("timerbars", "circle_checkpoints", cpX, y, Helpers.coordsAndSize.checkpointWidth, Helpers.coordsAndSize.checkpointHeight, 0.0, drawColor[0], drawColor[1], drawColor[2], drawColor[3], true);
...
export class ProgressBar extends BaseBar {
    ...
    draw(y) {
        ...
        native.drawRect(Helpers.coordsAndSize.progressBaseX, y, Helpers.coordsAndSize.progressWidth, Helpers.coordsAndSize.progressHeight, this._bgColor[0], this._bgColor[1], this._bgColor[2], this._bgColor[3], false);
        native.drawRect(this._fgX, y, this._fgWidth, Helpers.coordsAndSize.progressHeight, this._fgColor[0], this._fgColor[1], this._fgColor[2], this._fgColor[3], false);
    }
