...
function setWeaponDamages() {
    native.setWeaponDamageModifier(native.getHashKey(DamageModifiers[0].name), DamageModifiers[0].damage);
    native.setWeaponDamageModifier(native.getHashKey(DamageModifiers[1].name), DamageModifiers[1].damage);
...
let DamageModifiers = [
    ...
    {
        name: "weapon_grenadelauncher_mk2",
        damage: 0.1
    },
    {
